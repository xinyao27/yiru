...
import type { WorktreeCreateWireInput } from '../contract/worktree-input.js' with {
  'resolution-mode': 'import'
}
import type {
...
export const MOBILE_WORKSPACE_EVENTS_LIST_ORPC_PATH = '/workspaceEvents/list'
...
> extends WorktreeCreateWireInput
  ? true
  : false = true

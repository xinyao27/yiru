...
// Why: this pure filter/group/query core belongs in the protocol model so daemon and clients can
// share Agent Session History rules without importing an app implementation.
...
// ai-vault-session-projects runtime logic into the protocol model.

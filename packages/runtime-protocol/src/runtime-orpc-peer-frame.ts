const RUNTIME_ORPC_TEXT_PREFIX = 'yiru-orpc-v1:'
const RUNTIME_ORPC_BINARY_KIND = 0x6f
const RUNTIME_ORPC_BINARY_VERSION = 1
const RUNTIME_ORPC_BINARY_HEADER_BYTES = 2
const RUNTIME_ORPC_SIDE_CHANNEL_BINARY_KIND = 0x79
const RUNTIME_ORPC_SIDE_CHANNEL_BINARY_VERSION = 1
const RUNTIME_ORPC_SIDE_CHANNEL_HEADER_BYTES = 4

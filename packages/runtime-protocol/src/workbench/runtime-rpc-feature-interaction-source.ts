...
export const YIRU_RUNTIME_RPC_BROWSER_UI_SOURCE = 'browser-ui'

export function withBrowserUiRuntimeRpcSource(value: unknown): unknown {
...
export function isBrowserUiRuntimeRpcParams(value: unknown): boolean {
  return (
    value !== null &&
    typeof value === 'object' &&
    !Array.isArray(value) &&

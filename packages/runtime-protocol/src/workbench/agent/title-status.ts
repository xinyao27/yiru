import { isGrokRotatingWorkingTitle } from '@yiru/runtime-protocol/model/agent'
import {
  AGY_AGENT_NAME_RE,
  BRAILLE_SPINNER_RE,
  CLAUDE_IDLE,
...
import type { AgentStatus } from '@yiru/runtime-protocol/model/agent'
import { getPiCompatibleSyntheticAgentStatus } from '@yiru/runtime-protocol/model/agent'

...
import { getRepositoryGitAuthorSearchEntries } from './git-author-search-entries'
import { getRepositoryGitHooksSearchEntries } from './git-hooks-search-entries'
import { getRepositoryGitWorktreeSearchEntries } from './git-worktree-search-entries'

...
import { Info, ArrowClockwise as RotateCw } from '~renderer/icons/hugeicons'
...
export function AdvancedPane({ settings, updateSettings }: AdvancedPaneProps): React.JSX.Element {
  ...
  const showElectronCompatibility = usesNativeWindowRenderer()
  ...
  const handleHttp1CompatibilityRelaunch = (): void => {
    ...
    void shellClient.app.relaunch().catch((error) => {

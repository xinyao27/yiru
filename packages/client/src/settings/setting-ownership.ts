  ...
  return {
    ...
    agentLaunchDefaults: {
      ...
      description: translate(
        ...
        'Default agent, command overrides, CLI arguments, and launch environment are client preferences. Remote daemon launches still validate host availability at run time.'
      )
    },
    ...
    providerAccounts: {
      ...
      description: translate(
        ...
        'Credentials and account checks belong to the local or remote daemon that owns the provider integration.'
      )
    }
  }
}

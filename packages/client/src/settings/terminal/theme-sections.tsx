...
import { YamlThemeImportButton } from '../yaml-theme-import-button'
import { TerminalSettingsPreview } from './settings-preview'
  ...
  return (
    <section className="space-y-5">
      ...
      <div className="ml-4 grid gap-4">
        <div className={advancedContent ? 'border-border/40 border-b' : undefined}>

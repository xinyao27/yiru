...
import { useSourceControlActionRecipeDraftState } from './action-recipe-draft-state'
import { SourceControlActionRecipeRow } from './action-recipe-row'
import { SourceControlActionRepoOverrideNote } from './action-repo-override-note'
...
export function SourceControlAiActionRecipeDefaults({
  ...
  const repos = (() => allRepos.filter((repo) => !isFolderRepo(repo)))()

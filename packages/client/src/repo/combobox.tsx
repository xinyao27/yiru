...
import { Check, CaretUpDown as ChevronsUpDown, FolderPlus } from '~renderer/icons/hugeicons'
...
export default function RepoCombobox({
  ...
  const selectedRepo = (() => repos.find((repo) => repo.id === value) ?? null)()
  const filteredRepos = (() => searchRepos(repos, query))()

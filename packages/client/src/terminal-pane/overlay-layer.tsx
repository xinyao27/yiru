...
const TerminalOverlaySlot = function TerminalOverlaySlot({
  terminalTabId,
  terminalGeneration,
  worktreeId,
  worktreePath,
  ...
  const shouldMeasureHiddenStartup = useAppStore(
    (state) => state.pendingStartupByTabId[terminalTabId] !== undefined && !isVisible
  )
  useLayoutEffect(() => {
...
const TerminalPaneOverlayLayer = function TerminalPaneOverlayLayer({
  worktreeId,
  worktreePath,
  isWorktreeActive,

import { TERMINAL_SCROLLBACK_SESSION_BUFFER_BYTE_LIMIT } from '@yiru/runtime-protocol/workbench/terminal/scrollback-limits'
import { serializeWithAbsoluteCursor } from '@yiru/runtime-protocol/workbench/terminal/serialize-absolute-cursor'
import type { TerminalLayoutSnapshot } from '@yiru/runtime-protocol/workbench/types'
import { measureUtf8ByteLength } from '@yiru/runtime-protocol/workbench/utf8-byte-limits'
import type { ManagedPane } from '~renderer/terminal-pane/pane-manager/pane-manager'
import { flushTerminalOutput } from '~renderer/terminal-pane/pane-manager/pane-terminal-output-scheduler'
import { resolveTerminalLayoutActiveLeafId } from '~renderer/terminal-pane/terminal-layout-leaf-ids'

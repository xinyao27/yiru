import { safeFit } from '~renderer/terminal-pane/pane-manager/pane-fit'
import { deferTerminalGeometryMutationDuringRebuild } from '~renderer/terminal-pane/pane-manager/terminal-scroll-intent-rebuild'
import type { ManagedPane } from '~renderer/terminal-pane/pane-manager/types'

...
import { FileExplorerNameFilter } from './name-filter'
import { FileExplorerQueryStrip } from './query-strip'
...
// return for detail.
export const FileExplorerQueryHeaderMemo = FileExplorerQueryHeader

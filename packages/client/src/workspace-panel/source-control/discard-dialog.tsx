...
export function SourceControlDiscardDialog({
  ...
  const pendingDiscardDeletes = pendingDiscardCopy?.confirmLabel.startsWith('Delete') === true
  const PendingDiscardIcon = pendingDiscardDeletes ? Trash : Undo2

...
import { ContextMenu, ContextMenuContent, ContextMenuTrigger } from '~renderer/ui/context-menu'
import {
      ...
      <ContextMenuTrigger
        ...
        render={
          ...
          >
            ...
            {!detailsExpanded ? (
              <>
                <div className="text-muted-foreground mt-0.5 line-clamp-2 min-w-0 text-[12px] leading-4">
                  {latestTurn ? (
                    <>

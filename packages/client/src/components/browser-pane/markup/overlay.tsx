...
import { Check, X } from '~renderer/components/icons/hugeicons'
...
import { TEXT_FONT_FAMILY } from './shape-render'
import { MarkupToolbar } from './toolbar'
import { useMarkupEditor } from './use-markup-editor'
    ...
    >
      ...
      {pendingText ? (
        ...
        <input
          ...
          className="absolute z-30 [field-sizing:content] min-w-0 border-0 bg-transparent p-0 leading-none outline-none"
          style={{
            left: pendingText.x,
            top: pendingText.y,
            color: editor.color,

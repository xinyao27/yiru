...
export class RemoteRuntimePtyConnection {
  ...
  private async attachHostSessionMirror(
    ...
    const ptyId = toRuntimeTerminalPtyId(hostHandle, environmentIdForTarget(this.state.target))
  ...
  private async createTerminal(
    ...
    const ptyId = toRuntimeTerminalPtyId(terminal.handle, environmentId)

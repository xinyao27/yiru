import type { PRCommentGroupActionState } from '~renderer/components/workspace-panel/pr-comment-action-state'
...
const RESOLVED_SECTION_TRIGGER = cn(
  ...
  'border-0 bg-transparent px-3 py-2 hover:bg-accent/40 hover:text-foreground hover:no-underline'
)

import {
  ...
  LaptopIcon as HugeLaptopIcon,
  LayoutTopIcon as HugeLayoutTopIcon,
  TipsIcon as HugeTipsIcon,
  ZapIcon as HugeZapIcon,
  Link01Icon as HugeLink01Icon,
  Unlink01Icon as HugeUnlink01Icon,
  Link02Icon as HugeLink02Icon,
  Task01Icon as HugeTask01Icon,
  ...
  Plug01Icon as HugePlug01Icon,
  Add01Icon as HugeAdd01Icon,
  PowerIcon as HugePowerIcon,
  UnavailableIcon as HugeUnavailableIcon,
  PinIcon as HugePinIcon,
  PinOffIcon as HugePinOffIcon,
  PuzzleIcon as HugePuzzleIcon,
  QrCodeIcon as HugeQrCodeIcon,
  QuestionIcon as HugeQuestionIcon,
  QuotesIcon as HugeQuotesIcon,
  RadioIcon as HugeRadioIcon,
  Backward01Icon as HugeBackward01Icon,
  Robot01Icon as HugeRobot01Icon,
  Rocket01Icon as HugeRocket01Icon,
  LayoutThreeRowIcon as HugeLayoutThreeRowIcon,
  ScrollVerticalIcon as HugeScrollVerticalIcon,
  ...
  Summation02Icon as HugeSummation02Icon,
  LoginSquare02Icon as HugeLoginSquare02Icon,
  ...
  TeacherIcon as HugeTeacherIcon,
  Sun03Icon as HugeSun03Icon,
  ArrowDataTransferHorizontalIcon as HugeArrowDataTransferHorizontalIcon,
  TableIcon as HugeTableIcon,
  Tag02Icon as HugeTag02Icon,
  Target01Icon as HugeTarget01Icon,
  TerminalIcon as HugeTerminalIcon,
  CommandLineIcon as HugeCommandLineIcon,
  TextFontIcon as HugeTextFontIcon,
  TextAlignLeftIcon as HugeTextAlignLeftIcon,
...
import { createHugeIcon } from './hugeicon-renderer'
...
export const Laptop = createHugeIcon(HugeLaptopIcon)
export const Layout = createHugeIcon(HugeLayoutTopIcon)
export const Lightbulb = createHugeIcon(HugeTipsIcon)
export const Lightning = createHugeIcon(HugeZapIcon)
export const Link = createHugeIcon(HugeLink01Icon)
export const LinkBreak = createHugeIcon(HugeUnlink01Icon)
export const LinkSimple = createHugeIcon(HugeLink02Icon)
export const List = createHugeIcon(HugeListViewIcon)
export const ListChecks = createHugeIcon(HugeTask01Icon)
...
export const MagnifyingGlassPlus = createHugeIcon(HugeSearchAddIcon)
...
export const Plug = createHugeIcon(HugePlug01Icon)
export const Plus = createHugeIcon(HugeAdd01Icon)
export const Power = createHugeIcon(HugePowerIcon)
export const Prohibit = createHugeIcon(HugeUnavailableIcon)
export const PushPin = createHugeIcon(HugePinIcon)
export const PushPinSlash = createHugeIcon(HugePinOffIcon)
export const PuzzlePiece = createHugeIcon(HugePuzzleIcon)
export const QrCode = createHugeIcon(HugeQrCodeIcon)
export const Question = createHugeIcon(HugeQuestionIcon)
export const Quotes = createHugeIcon(HugeQuotesIcon)
export const Radio = createHugeIcon(HugeRadioIcon)
export const Rewind = createHugeIcon(HugeBackward01Icon)
export const Robot = createHugeIcon(HugeRobot01Icon)
export const Rocket = createHugeIcon(HugeRocket01Icon)
export const Rows = createHugeIcon(HugeLayoutThreeRowIcon)
export const Scroll = createHugeIcon(HugeScrollVerticalIcon)
...
export const SidebarSimple = createHugeIcon(HugeSidebarRightIcon)
export const Sigma = createHugeIcon(HugeSummation02Icon)
export const SignIn = createHugeIcon(HugeLoginSquare02Icon)
export const Siren = createHugeIcon(HugeAlert02Icon)
export const SlidersHorizontal = createHugeIcon(HugeSlidersHorizontalIcon)
export const Sparkle = createHugeIcon(HugeSparklesIcon)
...
export const Student = createHugeIcon(HugeTeacherIcon)
export const Sun = createHugeIcon(HugeSun03Icon)
export const Swap = createHugeIcon(HugeArrowDataTransferHorizontalIcon)
export const Table = createHugeIcon(HugeTableIcon)
export const Tag = createHugeIcon(HugeTag02Icon)
export const Target = createHugeIcon(HugeTarget01Icon)
export const Terminal = createHugeIcon(HugeTerminalIcon)
export const TerminalWindow = createHugeIcon(HugeCommandLineIcon)
export const TextAa = createHugeIcon(HugeTextFontIcon)
export const TextAlignLeft = createHugeIcon(HugeTextAlignLeftIcon)
export const TextB = createHugeIcon(HugeTextBoldIcon)
export const TextHFive = createHugeIcon(HugeHeading05Icon)
export const TextHFour = createHugeIcon(HugeHeading04Icon)
export const TextHOne = createHugeIcon(HugeHeading01Icon)
...
export const Upload = createHugeIcon(HugeUpload01Icon)
...
export const Wrench = createHugeIcon(HugeWrench01Icon)
export const X = createHugeIcon(HugeCancel01Icon)
export const XCircle = createHugeIcon(HugeCancelCircleIcon)

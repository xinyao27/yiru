...
import { getGeneralPaneSearchEntries } from '~renderer/components/settings/general/search'
import { getIntegrationsPaneSearchEntries } from '~renderer/components/settings/integrations-search'
import { getMobileSettingsPaneSearchEntries } from '~renderer/components/settings/mobile/settings-search'
import { getNotificationsPaneSearchEntries } from '~renderer/components/settings/notifications-search'
import { getOrchestrationPaneSearchEntries } from '~renderer/components/settings/orchestration/search'
import { getShortcutsPaneSearchEntries } from '~renderer/components/settings/shortcuts-search'

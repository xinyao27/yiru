...
import { getGeneralSupportSearchEntries } from './support-search'

export { getGeneralEditorSearchEntries } from './editor-search'
export { getGeneralSupportSearchEntries } from './support-search'

...
import { Info, Plus } from '~renderer/components/icons/hugeicons'
...
import AutomationProjectCombobox from './automation-project-combobox'
import { AutomationSessionField } from './automation-session-field'
import { AutomationSetupDecisionField } from './automation-setup-decision-field'
...
export function AutomationEditorDialogFooter({
  ...
  return (
    <div className="border-border/50 border-t px-5 py-4">
      ...
      {/* Why: Hermes uses one compact footer row, while Yiru adds agent,
      ...
      >
        <div className="min-h-0">
          ...
          <AutomationSetupDecisionField
            createTarget={isHermesTarget ? 'hermes' : 'yiru'}
            draft={draft}
            repos={repos}

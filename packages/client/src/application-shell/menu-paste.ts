...
import { findOwnedTextControlPasteTarget } from '../keyboard-input/paste/ownership'
import {
...
export async function handleAppMenuPasteRequest({
  ...
  try {
    ...
    // control gained focus, not the text control Yiru already resolved.
  ...
  // Why: for text controls Yiru has already resolved ownership. Falling back

...
export function ProjectGroupDeleteDialog({
  ...
  const handleDialogContentRef = (node: HTMLDivElement | null): void => {
      ...
      >
        <DialogHeader>
          ...
          <DialogDescription className="text-xs">
            ...
            <span className="text-foreground font-medium break-all">{groupName}</span>.
          </DialogDescription>
        </DialogHeader>
        {projectCount > 0 && (
          <div className="space-y-2 text-xs">
            {projectNames.length > 0 && (
              <div className="border-border/70 bg-muted/35 border px-3 py-2">
                ...
                <ul
                  className="text-foreground min-w-0 space-y-0.5"

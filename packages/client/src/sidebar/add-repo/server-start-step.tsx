...
import { FolderOpen, Globe, Lightbulb, HardDrives as Server } from '~renderer/icons/hugeicons'
...
function AddRepoServerStartAction({
  ...
  return (
    ...
    >
      ...
      <span className="min-w-0">
        <span className="text-foreground block text-[13px] leading-5 font-semibold">{title}</span>
        <span className="text-muted-foreground mt-0.5 block text-[11px] leading-4 font-normal">
          {description}
        </span>
      </span>
    </Button>

...
import { CandidateRowDetails } from './candidate-row-details'
import { getWorkspaceCleanupGitLabel, type WorkspaceCleanupReviewInfo } from './presentation'
...
export const CandidateRow = function CandidateRow({
  candidate,
  expanded,
  failure,
  last,

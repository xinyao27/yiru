...
import { queueHookCommandsForFirstWorktreeTab } from './hook-command-delayed-delivery'
import type { WorktreeActivationStore, WorktreeStartupPayload } from './worktree-activation-types'
import { applyDefaultTerminalTabs, resolveStartupAgent } from './worktree-default-tabs'

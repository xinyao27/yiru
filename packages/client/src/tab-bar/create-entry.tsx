...
export default function TabBarCreateEntry({
  ...
  const matchingMenuOptions = (() => findMatchingTabCreateMenuOptions(query, menuOptions))()
  const options = (() => {
  ...
  const matchingAgentOptions = (() => findMatchingTabAgentLaunchOptions(query, agentOptions))()

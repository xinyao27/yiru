...
type OpenExtensionTerminalMultiplexSubscriptionOptions = {
  requestId: string
  params: unknown
  runtimeId: string
  ...
  onCreated: (subscription: ExtensionTerminalMultiplexSubscription) => void
}

export type ExtensionTerminalMultiplexSubscription = {
  close: () => void
...
export async function openExtensionTerminalMultiplexSubscription({
  requestId,
  params,
  runtimeId,
  callbacks,
  ...
  sendBinary,
  onCreated
}: OpenExtensionTerminalMultiplexSubscriptionOptions): Promise<ExtensionTerminalMultiplexSubscription> {
  ...
  const subscription: ExtensionTerminalMultiplexSubscription = {
    close,

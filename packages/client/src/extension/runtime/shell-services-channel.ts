...
export class ExtensionShellServicesChannel {
  ...
  private readonly peer: ExtensionShellServicesPeer
  private isClosed = false

  constructor(sendText: SendText, sendBinary: SendBinary, onFailure: () => void) {
    this.peer = new ExtensionShellServicesPeer(sendText, sendBinary, onFailure)
  }
...
class ExtensionShellServicesPeer {

...
import { buildHostGroupIdByTabId, chooseTargetGroupId } from './web-session-group-mirror'
import { sameOpenFiles } from './web-session-store-equality'
import {
  browserWorkspaceHasRemoteEnvironmentPage,
  buildMirroredBrowserTabs,
  buildMirroredEditorTabs,
  buildTerminalUnifiedTab
} from './web-session-surface-mirror'
...
} from './web-session-terminal-layout'
import { buildMirroredTerminalTabs } from './web-session-terminal-mirror'

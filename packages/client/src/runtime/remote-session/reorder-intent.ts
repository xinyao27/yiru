...
export function recordRemoteSessionReorderIntent(
  worktreeId: string,
  groupId: string,
 ...
 */
export function resolveRemoteSessionReorderedOrder(
  worktreeId: string,
  groupId: string,
  hostOrder: string[],
  now: number
...
export function clearRemoteSessionReorderIntentsForWorktree(worktreeId: string): void {
  pendingReorderByWorktree.delete(worktreeId)
}

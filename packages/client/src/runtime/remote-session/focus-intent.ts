...
export function recordRemoteSessionFocusIntent(worktreeId: string, hostTabId: string): void {
...
export function peekRemoteSessionFocusIntent(worktreeId: string): string | null {
  return pendingFocusByWorktree.get(worktreeId) ?? null
}

export function clearRemoteSessionFocusIntent(worktreeId: string): void {

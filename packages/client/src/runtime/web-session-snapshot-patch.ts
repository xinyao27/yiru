...
import { sameStringArray } from './web-session-agent-status-equality'
import {
  appendTabGroupLayout,
  collectLayoutGroupIds,
  pruneTabGroupLayout,
  tabGroupLayoutEqual
} from './web-session-group-mirror'
import type { buildWebSessionGroupReconciliation } from './web-session-group-reconciliation'
import type { buildWebSessionResourceReconciliation } from './web-session-resource-reconciliation'
import type { resolveWebSessionSnapshotSelection } from './web-session-selection-reconciliation'
import {
  sameBrowserTabs,
  sameGroups,
  sameTerminalTabs,
  ...
  toVisibleTabType,
  withWorktreeEntry
} from './web-session-store-equality'
import type { buildWebSessionSurfaceMirror } from './web-session-surface-reconciliation'
import type { WebSessionTabsSyncState } from './web-session-tabs-state'
import { buildMirroredAgentStatusPatch } from './web-session-terminal-mirror'

export function buildWebSessionSnapshotPatch(input: {
  ...
  groupMirror: ReturnType<typeof buildWebSessionGroupReconciliation>
  resources: ReturnType<typeof buildWebSessionResourceReconciliation>

...
import { ClaudeIcon, DroidIcon, OpenAIIcon } from '~renderer/status-bar/icons'

import { AGENT_FAVICON_ASSETS } from '../agent-icons/favicon-assets'
import {
  AgentLetterIcon,
  AiderIcon,
  CopilotIcon,
...
export const getAgentCatalog = createLocalizedCatalog((): AgentCatalogEntry[] => [
  ...
  },
  {
    ...
    // Why: this must match the unambiguous executable used by TUI_AGENT_CONFIG.trae.
    cmd: 'traecli',

import { FOLDER_WORKSPACE_PATH_STATUS_RUNTIME_CAPABILITY } from '@yiru/runtime-protocol/capabilities'
import {
...
import type { FolderWorkspacePathStatusCacheEntry } from './repo-update-model'

...
import type { WorkspaceVisibleTabType, WorktreeMeta } from '~shared/types'
import { worktreeWorkspaceKey } from '~shared/workspace/scope'

import type { AppState } from '../types'
import { moveFocusToRendererBeforeFocusedWebviewHidden } from './browser-webview-cleanup'
import { getActiveUnifiedTabForWorktree } from './worktree-activation-model'
import { toVisibleTabType } from './worktree-host-model'
import {

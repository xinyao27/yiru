...
import { CaretUp as ChevronUp, CaretDown as ChevronDown, X } from '~renderer/icons/hugeicons'
...
export default function PdfFind({
  ...
  const dispatchFind = useEventCallback((type: string, findPrevious = false): void => {

...
import type { getEditorPanelRenderModel } from './panel-render-model'
import { UntitledFileRenameDialog } from './untitled-file-rename-dialog'
      ...
      <UntitledFileRenameDialog
        ...
        worktreePath={
          renameDialogFile
            ? getUntitledFileRoot(
                renameDialogFile,
                findWorktreeById(worktreesByRepo, renameDialogFile.worktreeId)?.path
              )
            : ''
        }

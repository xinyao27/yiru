...
import { Wrench } from '~renderer/icons/hugeicons'
  ...
  return (
    <div className="flex h-full flex-col gap-5">
      ...
      <div className="bg-foreground/[0.05] px-2 py-2.5">
        ...
        <div className="flex flex-col gap-3 pt-2.5 pr-2 pb-1 pl-[30px]">
          <AgentRow
...
function SupportedAgentsMarquee(props: { reducedMotion: boolean }): JSX.Element {
  ...
  return (
    <div className="border-border relative -mx-1 mb-1 overflow-hidden border-b pt-1 pb-2">
      <div

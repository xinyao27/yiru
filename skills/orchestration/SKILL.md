...
- `yiru` must be on PATH (`yiru-ide` on Linux).
...
The arguments intentionally omit an executable name so this works with `yiru`, `yiru-ide`, `yiru-dev`, or another configured Yiru CLI command.

  ...
  return (
    <div className="bg-page min-h-screen">
      <div className="mx-auto flex max-w-[1120px] items-start justify-center px-4 sm:px-6">
        ...
        <main className="border-hairline text-copy flex min-h-screen w-full max-w-[1120px] flex-col gap-7 px-6 pt-4 pb-20 text-[16px] leading-[26px] sm:border-x sm:px-18">
          <div className="flex flex-col gap-3 pt-24">
            <h1 className="text-ink text-[26px] leading-[1.2] font-semibold">Yiru</h1>
            <p className="max-w-[620px]">Run coding agents anywhere your code lives.</p>
          </div>

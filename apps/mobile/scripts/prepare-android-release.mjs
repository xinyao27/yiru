...
if (bumpPatch) {
  fail(
    'MOBILE_ANDROID_BUMP_PATCH_VERSION is no longer supported; commit apps/mobile/app.json first'
  )
}
...
if (requestedVersionCode || bumpVersionCode) {
  ...
  fail('Android versionCode changes must be committed in apps/mobile/app.json before release')
}

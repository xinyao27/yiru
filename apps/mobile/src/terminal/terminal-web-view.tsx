...
export const TerminalWebView = forwardRef<TerminalWebViewHandle, TerminalWebViewProps>(
  function TerminalWebView(
    ...
    const effectiveTerminalTheme = useTerminalWebViewTheme(terminalTheme)
    ...
    const confirmWebReady = useCallback(
      (notifyParent: boolean) => {
        ...
        sendToWebView({ type: 'set-theme', terminalTheme: effectiveTerminalTheme })
    ...
    useEffect(() => {
      postMessage({ type: 'set-theme', terminalTheme: effectiveTerminalTheme })
    }, [effectiveTerminalTheme, postMessage])

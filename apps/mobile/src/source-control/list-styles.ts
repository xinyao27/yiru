...
export const listStyles = {
  ...
  sectionTitle: cn('text-muted-foreground text-xs font-bold uppercase'),
  sectionCount: cn('text-muted-foreground text-xs font-semibold'),
  ...
  commitInput: cn(
    'border-hairline border-border bg-background text-foreground min-h-11 flex-1 rounded-xl px-3 text-sm'
  ),
  commitButtonDisabled: cn('opacity-50')
} as const

...
import { getMobileCommitFailureStagedEntries } from './commit-failure-recovery'
import {
...
import { buildMobileSourceControlPrimaryAction } from './primary-action'
import {
  buildMobileGitStatusEntryViews,
  formatBranchLabel,
  type MobileBranchEntryView
} from './screen-state'
import { useMobileSourceControlCommitFailure } from './use-commit-failure'
import { useMobileSourceControlCreatePrAction } from './use-create-pr-action'
import { useMobileGitRequests } from './use-git-requests'
import { useMobileSourceControlKeyboardLift } from './use-keyboard-lift'
import { useMobileSourceControlLoaders } from './use-loaders'
import { useMobileSourceControlOpeners } from './use-openers'
import { useMobileSourceControlRunners } from './use-runners'
...
export function useMobileSourceControlState(params: MobileSourceControlStateParams) {
  ...
  const { gitRequests, sendCommitRequest, runGitSyncSteps } = useMobileGitRequests({
    client,
    connState,
    worktreeId
  })

...
[`src/assets/main.css`](./src/renderer/src/assets/main.css) is the executable token source,
[`src/components/ui/`](./src/renderer/src/components/ui/) owns reusable primitives, and the

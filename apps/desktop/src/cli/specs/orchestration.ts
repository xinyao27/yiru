...
export const ORCHESTRATION_COMMAND_SPECS: CommandSpec[] = [
  {
    ...
    usage: 'yiru orchestration run-create --objective <text> [--from <handle>] [--json]',
  ...
  },
  {
    ...
    usage: 'yiru orchestration run-use --id <run_id> [--from <handle>] [--json]',
  ...
  },
  {
    ...
    usage:
      'yiru orchestration send --subject <text> [--to <run:id|dispatch:id|legacy_handle>] [--run <run_id>] [--from <handle>] [--body <text>] [--type <type>] [--priority <level>] [--thread-id <id>] [--payload <json>] [--task-id <id>] [--dispatch-id <id>] [--outcome <succeeded|failed>] [--files-modified <csv>] [--report-path <path>] [--phase <text>] [--json]',
    allowedFlags: [
      ...GLOBAL_FLAGS,
      'to',
      'run',
    ...
    notes: [
      ...
      'Use --to dispatch:<id> for attempt-specific coordinator guidance; Yiru durably relays it to a connected worker server.',
  ...
  },
  {
    ...
    usage:
      'yiru orchestration check [--terminal <handle>] [--run <run_id>] [--ack <delivery_id>] [--unread | --peek | --all] [--types <type,...>] [--format] [--wait] [--timeout-ms <n>] [--json]\n' +
  ...
  },
  {
    ...
    usage:
      'yiru orchestration reply --id <msg_id> --body <text> [--run <run_id>] [--from <handle>] [--json]',
  ...
  },
  {
    ...
    usage: 'yiru orchestration inbox [--limit <n>] [--terminal <handle>] [--full] [--json]',
  ...
  },
  {
    ...
    usage:
      'yiru orchestration task-create --spec <text> [--task-title <text>] [--display-name <text>] [--deps <json_array>] [--parent <task_id>] [--run <run_id>] [--from <handle>] [--json]',
    allowedFlags: [
      ...GLOBAL_FLAGS,
      'spec',
      'task-title',
  ...
  },
  {
    ...
    usage:
      'yiru orchestration task-list [--status <status>] [--ready] [--brief] [--run <run_id>] [--from <handle>] [--json]',
  ...
  },
  {
    ...
    usage:
      'yiru orchestration task-update --id <task_id> --status <status> [--result <json>] [--run <run_id>] [--from <handle>] [--json]',
  ...
  ...ORCHESTRATION_WORKER_COMMAND_SPECS,
  {
    ...
    usage:
      'yiru orchestration dispatch --task <task_id> --to <handle> [--from <handle>] [--run <run_id>] [--inject] [--dry-run] [--return-preamble] [--json]',
    allowedFlags: [
      ...GLOBAL_FLAGS,
      'task',
      'to',
  ...
  },
  {
    ...
    usage:
      'yiru orchestration dispatch-show --task <task_id> [--preamble] [--from <handle>] [--json]',
  ...
  },
  {
    ...
    usage:
      'yiru orchestration ask (--question <text> | --resume <message_id>) [--to <run:id>] [--run <run_id>] [--options <csv>] [--timeout-ms <n>] [--from <handle>] [--json]',
    allowedFlags: [
      ...GLOBAL_FLAGS,
      'to',
      'run',
  ...
  },
  {
    ...
    usage:
      'yiru orchestration coordinator-start --spec <text> [--from <handle>] [--poll-interval-ms <n>] [--max-concurrent <n>] [--worktree <selector>] [--json]',
    allowedFlags: [
      ...GLOBAL_FLAGS,
      'spec',
      'from',
  ...
  },
  {
    ...
    summary: 'Retired: load the current orchestration skill',
    usage: 'yiru orchestration coordinator-stop [--json]',
    allowedFlags: [...GLOBAL_FLAGS],
    notes: [
      'This command performs no effects and returns the exact `skills get orchestration --full` recovery action.'
    ]

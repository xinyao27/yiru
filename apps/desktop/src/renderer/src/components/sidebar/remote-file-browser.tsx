...
export function RemoteFileBrowser({
  ...
  return (
    <div ref={setBrowserRootRef} className="flex w-full min-w-0 flex-col gap-2">
      {/* Breadcrumb bar */}
      <div className="scrollbar-none flex min-h-[28px] items-center gap-0.5 overflow-x-auto">
        <button
          type="button"
          onClick={navigateUp}
      ...
      <div className="border-border bg-background overflow-hidden rounded-md border">
        <div className="scrollbar-sleek h-[240px] overflow-y-auto">
          {loading ? (
            ...
            !preview!.loading ? (
            <div className="flex h-full items-center justify-center">
              <p className="text-muted-foreground text-xs">{displayEmptyDirCopy}</p>
            </div>
            ...
            <div className="flex h-full items-center justify-center">
              <p className="text-muted-foreground text-xs">{displayNoMatchesCopy}</p>
              <p className="text-muted-foreground text-xs">{displayNoMatchesCopy}</p>
            </div>
          ) : (

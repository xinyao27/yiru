...
import { TabBarQuickCommandItem } from './tab-bar-quick-command-item'
          ...
          >
            ...
            <div className="border-border/50 border-t p-1">
              <button
                ...
                className="text-muted-foreground hover:bg-muted hover:text-foreground focus-visible:ring-ring flex w-full items-center gap-2 rounded-[5px] px-2 py-1.5 text-[12px] focus-visible:ring-1 focus-visible:outline-none"
              >

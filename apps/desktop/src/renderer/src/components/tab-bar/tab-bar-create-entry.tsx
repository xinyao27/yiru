    ...
    >
      <div className="-mx-1 flex items-center px-3">
        <Input
          ...
          className="text-foreground placeholder:text-muted-foreground h-9 rounded-none border-0 bg-transparent px-0 text-xs font-normal shadow-none placeholder:font-normal focus-visible:border-0 focus-visible:ring-0 aria-invalid:border-0 aria-invalid:ring-0 md:text-xs dark:bg-transparent"
        />
      </div>

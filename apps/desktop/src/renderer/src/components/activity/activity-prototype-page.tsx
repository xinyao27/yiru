              ...
              <DropdownMenuTrigger
                render={
                  <Button
                    ...
                    variant="outline"
                    size="sm"
                    className="text-muted-foreground hover:text-accent-foreground size-8 shrink-0 p-0"
...
function ActivityProjectLabel({ repo }: { repo: Repo | null }): React.JSX.Element {
  ...
  return (
    <div className="flex min-w-0 items-center gap-1.5">
      ...
      <span
        className="text-muted-foreground min-w-0 truncate text-[11px] font-semibold tracking-[0.04em] uppercase"
        title={label}
      >
        {label}
      </span>
...
function ActivityStatusGroupHeader({ group }: { group: ActivityThreadGroup }): React.JSX.Element {
  return (
    <div className="border-border bg-background sticky top-0 z-10 flex items-center gap-2 border-b px-3 py-1.5">
      {group.state ? (
        <span className="inline-flex size-4 shrink-0 items-center justify-center">
          ...
          <div className="flex min-w-0 items-start gap-2">
            <div className="min-w-0 flex-1 space-y-0.5">
              ...
              <div className="flex min-w-0 items-center gap-1.5 pt-0.5">
                <span className="text-muted-foreground/80 shrink-0 text-[10px]">{agentLabel}</span>
                {canJump ? (
                  <span
                    className={cn(
...
export default function ActivityPrototypePage(): React.JSX.Element {
  ...
  return (
    <div ref={setActivityPageRef} className="bg-background flex h-full min-h-0 flex-col pb-3">
      <main className="flex min-h-0 flex-1 overflow-hidden">
        <aside
          ref={threadListRef}
          className="border-border relative flex min-h-0 shrink-0 flex-col border-r"
          style={{ width: threadListWidth }}
        >
          <div className="border-border shrink-0 border-b px-2 pt-2 pb-2">
        ...
        <section className="min-w-0 flex-1 overflow-hidden">
          {selectedThread ? (
            <div className="flex h-full min-h-0 flex-col">
              ...
              <div className="border-border flex shrink-0 items-start gap-4 border-b px-4 pt-2 pb-3">
                <div className="min-w-0">
                  <div className="flex min-w-0 items-start gap-2">
                    ...
                    <h2 className="line-clamp-3 text-sm leading-snug font-semibold break-words">
              ...
              {(() => {
                ...
                if (!selectedHasLiveTab) {
                  return (
                    <div className="text-muted-foreground flex min-h-0 flex-1 flex-col items-center justify-center gap-2 p-4 text-sm">
                ...
                return (
                  <div className="relative min-h-0 flex-1 overflow-hidden bg-[var(--editor-surface)]">
                    <div
                    ...
                    {visibleThread && !stagedThread && !visiblePortalReady ? (
                      <div
                        className="pointer-events-none absolute inset-0 z-20 bg-[var(--editor-surface)]"
                        aria-hidden="true"
                      >
            ...
            <div className="text-muted-foreground flex h-full min-h-[240px] flex-col items-center justify-center gap-2 text-sm">
              {visibleThreads.length === 0 ? (
                <>

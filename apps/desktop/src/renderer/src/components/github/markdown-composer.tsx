import { ImageIcon, Paperclip } from '@phosphor-icons/react'
...
} from '@/components/editor/rich-markdown-link-bubble'
...
import { RichMarkdownToolbar } from '@/components/editor/rich-markdown-toolbar'
import { GitHubMarkdownComposerPreviewPane } from '@/components/github/markdown-composer-preview-pane'
import {
  GitHubMarkdownComposerTabbar,
  type ComposerTab
} from '@/components/github/markdown-composer-tabbar'
import { hasBoundedGitHubMarkdownImageUrlText } from '@/components/github/markdown-image-url'
...
export function GitHubMarkdownComposer({
  ...
  const editorPane = (
    <div className="scrollbar-sleek max-h-[360px] overflow-y-auto">

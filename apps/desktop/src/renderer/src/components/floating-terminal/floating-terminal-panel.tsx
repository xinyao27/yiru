...
import { FloatingTerminalOrchestrationDialog } from './floating-terminal-orchestration-dialog'
import { FloatingTerminalResizeHandles } from './floating-terminal-resize-handles'
import { FloatingTerminalWindowControls } from './floating-terminal-window-controls'
export { FloatingTerminalToggleButton } from './floating-terminal-toggle-button'
...
const EditorPanel = lazy(() => import('@/components/editor/editor-panel'))
...
function FloatingEmptyStateShortcut({
  ...
  return (
    <ShortcutKeyCombo
      ...
      className="[&>span]:text-foreground self-center justify-self-end opacity-90"

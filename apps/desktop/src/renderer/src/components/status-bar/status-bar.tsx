  ...
  return (
    ...
    >
      ...
      <DropdownMenuItem
        ...
        closeOnClick={false}
      >
        <span className="text-foreground max-w-[180px] truncate text-[12px]">
          {activeTarget?.label ??
      ...
      {accountsExpanded ? (
        <div className="px-1 pb-1">
          ...
          <div className="text-muted-foreground px-2 py-1.5 text-[10px] leading-4">
            {translate(
...
function InlineUsageSignInAction({
  ...
  return (
    <div className={cn('flex w-full items-center gap-2', isFetching ? 'animate-pulse' : '')}>
      <span className="text-muted-foreground min-w-0 flex-1 text-[10px]">
        {translate('auto.components.status.bar.StatusBar.f19a63e7cd', 'Sign in to see usage')}
      </span>
      <Button
        type="button"

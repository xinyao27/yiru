...
import { DiffSectionBody } from './diff-section-body'
...
import { useDiffSectionCommentActions } from './use-diff-section-comment-actions'
import { useDiffSectionFallbackCleanup } from './use-diff-section-fallback-cleanup'
import { useDiffSectionLayoutMetrics } from './use-diff-section-layout-metrics'
...
export function DiffSectionItem({
  ...
  return (
    <div ref={setSectionRootNode} className="border-border border-b">
      <DiffSectionHeader
        path={section.path}
        dirty={section.dirty}

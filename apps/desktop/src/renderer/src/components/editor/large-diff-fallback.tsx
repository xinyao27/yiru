...
export function LargeDiffFallback({
  ...
  return (
    <div
      ...
      className="border-border bg-muted/10 text-muted-foreground flex h-full min-h-[120px] items-center justify-center border px-4 py-6"
    >
      <div className="max-w-xl space-y-3 text-center">
        ...
        <div className="text-xs break-all">{filePath}</div>

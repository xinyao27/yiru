            ...
            {hasOutput && (
              <section className="border-border bg-background rounded-md border">
                ...
                <div className="px-3 py-3">
                  {details?.title && (
                    <div className="text-foreground mb-2 text-sm font-medium">{details.title}</div>
                  )}
                  {details?.summary && (
                    <CommentMarkdown
                      content={details.summary}
                      variant="document"
                      className="max-w-full min-w-0 overflow-hidden text-sm leading-relaxed break-words [&_a]:break-all [&_code]:break-words [&_pre]:max-w-full"
                    />
                  )}
                  {details?.text && (
                    <CommentMarkdown
                      ...
                      variant="document"
                      className="mt-3 max-w-full min-w-0 overflow-hidden text-sm leading-relaxed break-words [&_a]:break-all [&_code]:break-words [&_pre]:max-w-full"
                    />
                  )}
                </div>
              </section>

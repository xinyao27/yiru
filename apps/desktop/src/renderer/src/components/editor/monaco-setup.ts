...
import { installMonacoContextMenuPaste } from '~renderer/components/editor/install-monaco-context-menu-paste'
import { registerAstroLanguage } from '~renderer/lib/monaco-languages/register-astro'
import { registerJsonlLanguage } from '~renderer/lib/monaco-languages/register-jsonl'
import { registerNimLanguage } from '~renderer/lib/monaco-languages/register-nim'
import { registerSvelteLanguage } from '~renderer/lib/monaco-languages/register-svelte'
import { registerVueLanguage } from '~renderer/lib/monaco-languages/register-vue'
...
// blocked in Yiru's sandboxed renderer. Route it through the trusted IPC bridge

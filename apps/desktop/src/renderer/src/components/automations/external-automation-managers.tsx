...
} from './external-automation-run-table'
                ...
                return (
                  ...
                  >
                    <div className="min-w-0">
                      <div className="flex min-w-0 items-center gap-2">
                        ...
                        <Tooltip>
                          <TooltipTrigger
                            ...
                            render={
                              <span className="absolute top-2 right-3 inline-flex shrink-0 items-center gap-1.5">
                      ...
                      <div className="text-foreground/80 mt-1 truncate text-xs font-medium">

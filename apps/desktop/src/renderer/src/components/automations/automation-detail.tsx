  ...
  return (
    <div className="flex w-full flex-col gap-4">
      ...
      {automation.executionTargetType === 'ssh' ? (
        <div className="border-border/50 bg-muted/50 text-muted-foreground rounded-md border p-3 text-sm shadow-sm">
          {translate(
      ...
      {runNowAvailability?.canRunNow === false ? (
        <div className="border-border/50 bg-muted/40 text-muted-foreground rounded-md border p-3 text-sm shadow-sm">
          {runNowAvailability.message}
        </div>
      ) : null}

      <div className="border-border/50 bg-muted/30 grid grid-cols-[repeat(auto-fit,minmax(9rem,1fr))] gap-5 rounded-md border px-4 py-3 shadow-sm">
        <DetailMetric
      ...
      <div className="border-border/50 bg-muted/20 grid grid-cols-[repeat(auto-fit,minmax(9rem,1fr))] gap-5 rounded-md border px-4 py-3 shadow-sm">
        <DetailMetric

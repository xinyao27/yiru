  ...
  return (
    <div className="border-border/50 bg-muted/20 rounded-md border shadow-sm">
      <div className="border-border/50 flex items-center justify-between border-b px-3 py-2">
        ...
        <div className="text-muted-foreground text-xs">{runCountLabel}</div>
      </div>
      <div className="min-h-[18rem] min-w-0">
        <div className="border-border/50 text-muted-foreground grid grid-cols-[minmax(9rem,1fr)_minmax(10rem,1.1fr)_minmax(5rem,.55fr)_minmax(5rem,.55fr)_minmax(6rem,auto)] gap-3 border-b px-3 py-1.5 text-[11px] font-medium uppercase">
          <div>

...
type CoworkingTerminalReconnectOptions = {
  isCurrent: () => boolean
  onPending: () => void
  onAttempt: () => void
}
...
export function useCoworkingTerminalReconnect(options: CoworkingTerminalReconnectOptions): {
  startReconnect: () => void
  retryReconnect: () => void
  resetReconnect: () => void
} {
...
export function isRecoverableCoworkingTerminalError(

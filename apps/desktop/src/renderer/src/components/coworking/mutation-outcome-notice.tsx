...
export function CoworkingMutationOutcomeNotice({
  description,
  onDismiss
}: {
  description: string
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        <p className="text-foreground text-xs font-medium">
          {translate(
            'auto.components.coworking.CoworkingMutationOutcomeNotice.title',
      ...
      <Button type="button" size="sm" variant="ghost" className="h-7" onClick={onDismiss}>
        {translate(
          'auto.components.coworking.CoworkingMutationOutcomeNotice.dismiss',

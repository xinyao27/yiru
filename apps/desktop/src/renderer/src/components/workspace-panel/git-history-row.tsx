  ...
  return (
    <Tooltip>
      <TooltipTrigger
        render={
          <span
            className="bg-sidebar max-w-[8rem] truncate border px-1.5 py-0.5 text-[10px] leading-none"
            style={{
  ...
  function GitHistoryRow(
      ...
      <>
        ...
        <div className="flex min-w-0 items-center gap-1 overflow-hidden">
          ...
          <Tooltip>
            <TooltipTrigger
              render={
                <span className="text-foreground block min-w-0 flex-1 truncate" title={rowTooltip}>
                  {item.subject}
                </span>
              }
            />
    ...
    return (
      <Button
        ...
        type="button"
        className={cn('p-0 h-auto border-0 focus-visible:bg-accent', rowClassName)}
        title={rowTooltip}

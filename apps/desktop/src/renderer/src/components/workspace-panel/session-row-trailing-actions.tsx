            ...
            <TooltipTrigger
              render={
                <Button
                  ...
                  className="can-hover:pointer-events-none group-focus-within/session-row:pointer-events-auto group-hover/session-row:pointer-events-auto focus-visible:pointer-events-auto"
                >
...
function WorktreeJumpTooltipTrigger({
  ...
  return (
    <TooltipTrigger
      render={
        <span
          className="can-hover:pointer-events-none inline-flex group-focus-within/session-row:pointer-events-auto group-hover/session-row:pointer-events-auto"
          onClick={(event) => event.stopPropagation()}
        >
          {button}
        </span>

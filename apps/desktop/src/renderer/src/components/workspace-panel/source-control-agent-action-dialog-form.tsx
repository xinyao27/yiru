...
import type { SourceControlLaunchActionId } from '../../../../shared/source-control/source-control-ai-actions'
...
export function SourceControlAgentActionDialogForm({
  ...
  return (
    <div className="flex min-h-0 flex-col gap-4">
      <div className="scrollbar-sleek max-h-[min(60vh,31rem)] min-h-0 min-w-0 space-y-4 overflow-y-auto pr-1">
          ...
          >
            <label className="grid cursor-pointer grid-cols-[1rem_1fr] items-start gap-2.5">
              <Checkbox
                ...
                onCheckedChange={(checked) => onSaveLaunchRecipeChange(checked === true)}
                className="mt-0.5"
              />
              <span>
            ...
            {deliveryPlan.status === 'error' ? (
              ...
              <div className="space-y-1.5">
                <div className="text-foreground flex items-start gap-2">
                  <CheckCircle2 className="mt-px size-3.5 shrink-0 text-green-700 dark:text-green-300" />

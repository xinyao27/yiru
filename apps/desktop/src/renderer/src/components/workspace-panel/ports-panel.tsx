...
const LOCAL_PORT_MENU_ITEM_CLASS =
  'focus:bg-accent focus:text-accent-foreground dark:focus:bg-accent'
      ...
      {allForwards.length > 0 && (
        <div className="px-3 pt-2">
          ...
          >
            ...
            <span className="text-muted-foreground/60 ml-1 text-[10px]">{allForwards.length}</span>
          </Button>
          {!forwardedCollapsed &&
      ...
      {allDetected.length > 0 && (
        <div className="px-3 pt-2">
          ...
          >
            ...
            <span className="text-muted-foreground/60 ml-1 text-[10px]">{allDetected.length}</span>
          </Button>
          {!detectedCollapsed &&
    ...
    <div className="group hover:bg-accent/50 -mx-1 flex items-center gap-2 px-1 py-1 transition-colors">
      ...
      <div className="can-hover:opacity-0 flex items-center gap-0.5 transition-opacity group-focus-within:opacity-100 group-hover:opacity-100">
        ...
        <Button
          ...
          size="xs"
          type="button"
          className={cn('h-auto border-0 ', 'p-1 ', removing && 'opacity-50')}

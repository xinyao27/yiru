...
function CommitFileRow({
  ...
  return (
    <Button
      ...
      size="xs"
      type="button"
      className="group hover:bg-accent/40 focus-visible:bg-accent/40 flex h-auto w-full min-w-0 justify-start border-0 py-1 pr-3 pl-9 text-left font-normal whitespace-normal transition-colors"
      title={entry.path}
    ...
    <>
      ...
      {onOpenAll && (
        <Button
          ...
          size="xs"
          type="button"
          className="/40 /40 flex h-auto w-full justify-start border-0 py-1 pr-3 pl-9 text-left text-[11px] font-normal whitespace-normal"
          onClick={onOpenAll}
        >
          <ArrowUpRight weight="regular" className="size-3 shrink-0" />
          <span>
            {translate(

...
export type YiruProfileSwitchLiveWorkSummary = {
  hasLiveWork: boolean
...
export function getYiruProfileSwitchLiveWorkSummary(
  state: YiruProfileSwitchLiveWorkState,
  now = Date.now()
): YiruProfileSwitchLiveWorkSummary {
...
export function getYiruProfileProjectLiveWorkSummary(
  state: YiruProfileSwitchLiveWorkState,
  repoId: string,
  now = Date.now()
): YiruProfileSwitchLiveWorkSummary {
  ...
  return getYiruProfileSwitchLiveWorkSummary(
    {
      agentStatusByPaneKey,
      browserTabsByWorktree,
      ptyIdsByTabId,
...
function getLiveTerminalSummary(state: YiruProfileSwitchLiveWorkState): {
  livePtyCount: number
  liveTerminalTabCount: number
} {
...
function getLiveAgentKeys(state: YiruProfileSwitchLiveWorkState, now: number): Set<string> {

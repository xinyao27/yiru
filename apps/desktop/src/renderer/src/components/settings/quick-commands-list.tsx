  ...
  return (
    <div className="border-border/60 bg-background flex items-center gap-3 border px-3 py-2">
      <div className="min-w-0 flex-1">
        ...
        <div className="text-foreground/80 flex min-w-0 items-center gap-1.5 text-xs">
      ...
      <div className="text-foreground/75 shrink-0 text-[11px] font-medium">
        {isTerminalAgentQuickCommand(command)
  ...
  return (
    <div className="border-border/50 bg-muted/20 overflow-hidden border">
      {visibleCommands.length === 0 ? (
        ...
        <div className="scrollbar-sleek max-h-[60vh] space-y-2 overflow-y-auto p-2">

...
import { ShortcutCommandBlock } from './shortcut-command-block'
import type { ShortcutRowsByGroup } from './shortcut-filter-rail'
    ...
    <div className={cn('flex flex-col gap-8', className)}>
      {groups.map((group) => (
        <div key={group.title} className="space-y-3">
          <h3 className="border-border/50 text-muted-foreground border-b pb-2 text-sm font-medium">
            {group.title}
          </h3>

import { Trash as Trash2, X } from '@phosphor-icons/react'

import { LoadingIndicator } from '@/components/loading-indicator'
import { ArrowClockwise as RefreshCw, ArrowClockwise as RotateCw } from '@/components/regular-icons'
...
export function ManageSessionsTable({
  ...
  return (
    <div className="border-border/60 flex flex-col overflow-hidden rounded-lg border">
      ...
      {!hasLoadedOnce ? (
        <div className="text-muted-foreground flex items-center justify-center px-3 py-8 text-xs">

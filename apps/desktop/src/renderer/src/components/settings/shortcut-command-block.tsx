...
import { ShortcutBindingSubRow } from './shortcut-binding-sub-row'
import { ShortcutRecorderButton } from './shortcut-recorder-button'
import { ShortcutRemoveButton } from './shortcut-remove-button'
    ...
    >
      <div className="hover:bg-accent/40 focus-within:bg-accent/40 flex min-h-9 items-center gap-3 px-2 py-1 transition-colors">
            ...
            <Tooltip>
              <TooltipTrigger
                render={
                  <Badge
                    variant="outline"
                    className="border-border/70 text-muted-foreground shrink-0 gap-1 text-[11px]"
                  >
        ...
        <div className="flex shrink-0 items-center gap-1">
          ...
          <div className="can-hover:opacity-0 flex items-center gap-0.5 transition-opacity group-focus-within/shortcut:opacity-100 group-hover/shortcut:opacity-100">

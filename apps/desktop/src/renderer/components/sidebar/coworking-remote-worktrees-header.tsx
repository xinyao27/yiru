...
export function CoworkingRemoteWorktreesHeader({
  expanded,
  onToggle
}: {
  expanded: boolean
  ...
  const label = translate('auto.components.sidebar.CoworkingRemoteWorktreesHeader.title', 'Remote')
  return (
    <div className="pt-1" data-coworking-remote-worktrees-header="">

 ...
 *  `prefix` — i.e. `whole` is `prefix` extended at the tail, so a consumer
 *  feeding this assembler can splice just the suffix instead of resetting. */
export function sharesPrefix(

...
function CoworkingVisibilityConfirmation({
  open,
  copy,
  publish,
  onOpenChange
    ...
    <Dialog open={open} onOpenChange={publishing ? undefined : onOpenChange}>
      <DialogContent showCloseButton={!publishing} className="sm:max-w-md">
        ...
        <DialogFooter>
          ...
          >
            {translate(
              'auto.components.coworking.CoworkingWorktreeVisibilityDialog.cancel',
              'Cancel'
            )}
          </Button>
...
export function CoworkingWorktreeVisibilityDialog({
  open,
  worktreeId,
  worktreeName,
  onOpenChange
  ...
  return (
    <CoworkingVisibilityConfirmation
      open={open}
      ...
      copy={{
        title: translate(
          'auto.components.coworking.CoworkingWorktreeVisibilityDialog.title',
          'Make {{value0}} public?',
          { value0: worktreeName }
        ),
        description: translate(
          'auto.components.coworking.CoworkingWorktreeVisibilityDialog.description',
          'People using Yiru Desktop on your Tailnet will be able to open this worktree.'
        ),
        historyWarning: translate(
          'auto.components.coworking.CoworkingWorktreeVisibilityDialog.historyWarning',
          'All existing sessions, transcripts, terminal scrollback, and future terminal output will be readable.'
        ),
        shellWarning: translate(
          'auto.components.coworking.CoworkingWorktreeVisibilityDialog.shellWarning',
          'Terminal history may include content produced outside this worktree.'
        ),
        confirm: translate(
          'auto.components.coworking.CoworkingWorktreeVisibilityDialog.confirm',
          'Make public'
        ),
        failure: translate(
          'auto.components.coworking.CoworkingWorktreeVisibilityDialog.publishFailed',
...
export function CoworkingProjectVisibilityDialog({
  open,
  projectId,
  projectName,
  onOpenChange
  ...
  return (
    <CoworkingVisibilityConfirmation
      ...
      copy={{
        title: translate(
          'auto.components.coworking.CoworkingWorktreeVisibilityDialog.projectTitle',
          'Make every current worktree in {{value0}} public?',
          { value0: projectName }
        ),
        description: translate(
          'auto.components.coworking.CoworkingWorktreeVisibilityDialog.projectDescription',
          'This applies once to every worktree currently in the project. Future worktrees remain private.'
        ),
        historyWarning: translate(
          'auto.components.coworking.CoworkingWorktreeVisibilityDialog.projectHistoryWarning',
          'All sessions, transcripts, terminal scrollback, and future terminal output in those worktrees will be readable.'
        ),
        shellWarning: translate(
          'auto.components.coworking.CoworkingWorktreeVisibilityDialog.projectShellWarning',
          'Terminal history may include content produced outside those worktrees.'
        ),
        confirm: translate(
          'auto.components.coworking.CoworkingWorktreeVisibilityDialog.projectConfirm',
          'Make all public'
        ),
        failure: translate(
          'auto.components.coworking.CoworkingWorktreeVisibilityDialog.projectPublishFailed',

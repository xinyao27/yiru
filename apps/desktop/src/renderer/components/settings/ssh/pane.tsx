...
import { HostRemoveDialog } from '~renderer/components/sidebar/host-remove-dialog'
import { resolveSshHostRemoval } from '~renderer/components/sidebar/ssh-host-remove-resolution'
...
import { SshTargetCard } from './target-card'
import { SshTargetDestructiveActions } from './target-destructive-actions'
import { getEditingTargetForSshTarget } from './target-draft'
import { SshTargetForm, EMPTY_FORM, type EditingTarget } from './target-form'
import { removeSshTargetWithBestEffortCleanup } from './target-remove'
import { buildSshTargetSavePayload } from './target-save-payload'
export { getSshPaneSearchEntries } from './search'
...
export function SshPane(): React.JSX.Element {
  ...
  // global store (via use-ipc-events.ts). Reading from the store avoids

...
import { getDefaultSourceControlAiSettings } from './source-control/source-control-ai'
import { DEFAULT_SOURCE_CONTROL_GROUP_ORDER } from './source-control/source-control-group-order'
...
export function getDefaultSettings(homedir: string): GlobalSettings {
  return {
    ...
    // terminal is a core Yiru workflow; users who prefer TUI ownership opt in.

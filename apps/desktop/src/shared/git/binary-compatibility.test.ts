...
import { gitCredentialPromptGuardEnv } from './credential-prompt-env'
import {
  isUnsupportedMergeTreeMergeBaseError,
  isUnsupportedMergeTreeWriteTreeError
} from './merge-tree-capability'
import { isForEachRefExcludeUnsupportedError } from './ref-command-capabilities'
import {
  hasUnsupportedRevParsePathFormatEcho,
  isUnsupportedWorktreeListZError
} from './worktree-command-capabilities'

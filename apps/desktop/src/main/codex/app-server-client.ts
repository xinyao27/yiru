...
import { runCodexAppServerSession, type CodexAppServerInvocation } from './app-server-session'
...
// canonical-JSON identity. Yiru used to replicate that algorithm
...
export type CodexHookTrustGrantRequest = {
   ...
   *  the managed entries Yiru just wrote. Grants are restricted to hooks whose

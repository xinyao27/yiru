...
const YIRU_CLAUDE_SERVICE = 'Yiru Claude Code Managed Credentials'
...
export async function readManagedClaudeKeychainCredentials(
  ...
  return readKeychainPassword(YIRU_CLAUDE_SERVICE, accountId)
}
...
export async function writeManagedClaudeKeychainCredentials(
  ...
  await writeKeychainPassword(YIRU_CLAUDE_SERVICE, accountId, contents)
}

export async function deleteManagedClaudeKeychainCredentials(accountId: string): Promise<void> {
  await deleteKeychainPassword(YIRU_CLAUDE_SERVICE, accountId)
}

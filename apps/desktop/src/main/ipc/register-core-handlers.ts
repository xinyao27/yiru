...
import { registerEmulatorFrameStreamHandlers } from '../emulator/emulator-frame-stream'
import { registerEmulatorVideoStreamHandlers } from '../emulator/emulator-video-stream'
...
import { registerFilesystemWatcherHandlers } from '../filesystem/filesystem-watcher'
...
import { registerMiniMaxCredentialsHandlers } from '../minimax/minimax-credentials'
...
import { registerRuntimeEnvironmentHandlers } from '../runtime/runtime-environments'

...
import { isForEachRefExcludeUnsupportedError } from '../../shared/git/git-ref-command-capabilities'
...
export { isForEachRefExcludeUnsupportedError } from '../../shared/git/git-ref-command-capabilities'

...
export const COWORKING_SESSION_INVENTORY_SNAPSHOT_MAX_RETAINED_BYTES = 256 * 1024 * 1024
// Why: an opening can hold both transcript and Codex-home paths before its exact size is known.
export const COWORKING_SESSION_INVENTORY_SNAPSHOT_OPENING_RESERVATION_BYTES =
  2 * COWORKING_SESSION_INVENTORY_MAX_PATH_BYTES +
  COWORKING_SESSION_INVENTORY_MAX_CANDIDATES * CANDIDATE_OBJECT_OVERHEAD_BYTES

export function estimateCoworkingSessionInventorySnapshotBytes(

...
import type { SpoolTerminalHost } from './structured-host-adapter'
import type { SpoolPublicWorktreeInstance } from './worktree-publication-state'
import type { YiruSpoolHostTerminalLaunch } from './yiru-host-terminal-launch'
...
export class YiruSpoolHostTerminal implements SpoolTerminalHost {
  ...
  constructor(
    ...
    private readonly launch?: YiruSpoolHostTerminalLaunch
  ) {}

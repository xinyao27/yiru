import { isValidSpoolCanonicalPath } from './canonical-host-path'
import { sameSpoolFolderRepoRoot } from './publication-root-availability'
import type {
  SpoolPreparedSessionRootMatcher,
  SpoolSessionRootMatch,
  SpoolSessionRootMatcher
} from './session-source'
import type { SpoolOwnerWorktree, SpoolRegisteredWorktreeRoot } from './worktree-incarnation'
import type {

...
import type { Repo, WorktreeStartupLaunch, TuiAgent } from '~shared/types'

import type { WorktreeStartupDraftPaste, WorktreeStartupFollowup } from '../model/terminal-startup'
import { RuntimeWorktreeResolvePairedRuntimeCoworkingWorktree } from './resolve-paired-runtime-coworking-worktree'

export abstract class RuntimeWorktreeBuildStartupForDraft extends RuntimeWorktreeResolvePairedRuntimeCoworkingWorktree {

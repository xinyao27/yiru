...
import { RuntimeRepositoryGetHostedReviewForBranch } from './get-hosted-review-for-branch'

export abstract class RuntimeRepositoryResolveGitLabRepoMrdiscussion extends RuntimeRepositoryGetHostedReviewForBranch {

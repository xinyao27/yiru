...
import { RuntimeRepositoryMoveProjectToGroup } from './move-project-to-group'

export abstract class RuntimeRepositoryAnalyzeWorkspaceSpace extends RuntimeRepositoryMoveProjectToGroup {

...
import type { TerminalQuickCommand, TerminalQuickCommandMutation } from '@yiru/workbench-model/ui'
...
import type { GlobalSettings, PersistedUIState, StatsSummary, MemorySnapshot } from '~shared/types'
...
export abstract class RuntimeContractGetLocalProvider {
  ...
  abstract updateClientPRBotAuthorOverride(args: { author: string; isBot: boolean })

...
export async function createWorkerWorktree(args: {
  ...
  coordinatorWorktree: Awaited<ReturnType<YiruRuntimeService['showManagedWorktree']>>
  params: {
    repo?: string
    name?: string
    baseBranch?: string
  ...
  worktree: Awaited<ReturnType<YiruRuntimeService['showManagedWorktree']>>
  ...
  return {
    worktree: created.worktree as Awaited<ReturnType<YiruRuntimeService['showManagedWorktree']>>,
    terminalHandle,
    setupReceipt
  }
}

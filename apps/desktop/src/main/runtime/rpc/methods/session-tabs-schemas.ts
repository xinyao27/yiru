...
import { sleepingAgentLaunchConfigSchema } from '../../../../shared/workspace/workspace-session-sleeping-agents'
...
export const CreateTerminalTab = WorktreeTabSelector.extend({
  ...
  agent: z
    ...
    .optional(),
  // Why: the host must quote/inject prompts for the native, WSL, or SSH shell
  // instead of letting mobile paste before the selected TUI is ready.
  agentPrompt: z
    .string()

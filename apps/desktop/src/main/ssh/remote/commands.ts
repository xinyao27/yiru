...
import { isWindowsRemoteHost, joinRemotePath, remoteDirname } from './platform'
import { powerShellCommand, powerShellLiteral, powerShellNativeArg } from './powershell'
...
export function relayLivenessProbeCommand(
  ...
  const js = [
    ...
    'const valid=/^\\\\\\\\[.?]\\\\pipe\\\\yiru-relay-[0-9a-f]{20}$/i;',
    'const pipes=[];',
    'let markerCount=0;',

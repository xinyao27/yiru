...
import type { Repo, FolderWorkspace } from '~shared/types'
import { folderWorkspaceKey } from '~shared/workspace/scope'

import { removeWorkspaceSessionOwner } from './persisted-state/workspace-session-owner-removal'
import { StoreLayer2 } from './persistence-store-layer-2'

export abstract class StoreLayer3 extends StoreLayer2 {

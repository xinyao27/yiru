...
import { optionalNumberParam, optionalStringParam } from './platform-script-provider-params'
import type { BridgeElement, BridgeRequest, BridgeSnapshot } from './platform-script-provider-types'
import type { ComputerProviderActionMethod } from './provider-action-validation'
import { RuntimeClientError } from './runtime-client-error'

export function bridgeTool(method: ComputerProviderActionMethod): string {
  return {
    click: 'click',

// Codex JSONL line → AgentTranscriptMessage decoder.
...
function codexCompletedMessageBlocks(content: unknown): AgentTranscriptBlock[] {
...
function codexToolResult(output: unknown, callId: string | null): AgentTranscriptBlock {

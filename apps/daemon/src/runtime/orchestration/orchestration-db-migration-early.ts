...
import { OrchestrationDbLayer1 } from './orchestration-db-layer-1'

export abstract class OrchestrationDbMigrationEarly extends OrchestrationDbLayer1 {
  protected migrateThroughVersion8(current: number): void {

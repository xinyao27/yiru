...
import { RemoteRuntimeRequestConnection } from '~main/remote-runtime/request-connection'
import { remoteRuntimeUnavailableError } from '~main/remote-runtime/request-frames'
import { RemoteRuntimeSharedControlConnection } from '~main/remote-runtime/shared-control-connection'
...
// Why: daemon-to-daemon callers use paired-runtime forwarding

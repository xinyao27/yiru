...
import type { ClaudeAgentTeamsMode } from '@yiru/runtime-protocol/workbench/claude-agent-teams-tmux-compat'
...
export type TerminalCreateOptions = {
  ...
  /** Why: remote-daemon grants can be revoked during async launch preparation. */

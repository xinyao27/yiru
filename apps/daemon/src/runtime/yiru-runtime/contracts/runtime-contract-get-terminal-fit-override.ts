import type { TerminalFitOverride } from '../../terminal-session-authority/terminal-session-layout-types'
import type {
  ApplyLayoutResult,
  DriverState,
  PtyLayoutState,
...
export abstract class RuntimeContractGetTerminalFitOverride extends RuntimeContractRecordRecentPtyOutputForPathProvenance {
  abstract getTerminalFitOverride(ptyId: string): TerminalFitOverride | null

import type { PRRefreshOutcome } from '@yiru/runtime-protocol/model/review'
import {
  getRepoExecutionHostId,
  LOCAL_EXECUTION_HOST_ID
} from '@yiru/runtime-protocol/model/workspace'
import { githubAvatarIcon } from '@yiru/runtime-protocol/model/workspace'
import type { Repo } from '@yiru/runtime-protocol/workbench/types'
import type { GitLabProjectRef, ListWorkItemsResult } from '@yiru/runtime-protocol/workbench/types'
import {
  type getPRForBranch,
...
export const getRepoUpstreamMethods = {

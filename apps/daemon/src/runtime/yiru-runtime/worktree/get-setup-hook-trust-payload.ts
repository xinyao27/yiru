...
import { inspectSetupScriptImportCandidates } from '@yiru/runtime-protocol/workbench/setup/script-imports'
import type {
  DetectedWorktree,
...
import { RuntimeRepositoryService } from '../repository/runtime'

export abstract class RuntimeWorktreeGetSetupHookTrustPayload extends RuntimeRepositoryService {

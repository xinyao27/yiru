...
import { GIT_FETCH_SKIP_AUTO_MAINTENANCE_CONFIG_ARGS } from '~main/git/runner/fetch-auto-maintenance'
...
export abstract class RuntimeWorktreeGetCanonicalFetchKey extends RuntimeWorktreeCreateManagedWorktree {
  async getCanonicalFetchKey(
    ...
    const runtimeKey = gitOptions.wslDistro
      ? toWslExecutionHostId(gitOptions.wslDistro)
      : LOCAL_EXECUTION_HOST_ID

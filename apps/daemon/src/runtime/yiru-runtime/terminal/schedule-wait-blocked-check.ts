...
} from '@yiru/runtime-protocol/workbench/agent/status-osc'
import type { TerminalChunkScanFlags } from '@yiru/runtime-protocol/workbench/terminal/chunk-scan-flags'
import type { PtyTransientFact } from '~main/agents/provider-runtime/types'
...
export abstract class RuntimeTerminalScheduleWaitBlockedCheck extends RuntimeTerminalOnPtyData {
  ...
  protected processAgentStatusOscForPty(
    ptyId: string,
    data: string,
    ...
    return processor(data, scanFlags)
  }

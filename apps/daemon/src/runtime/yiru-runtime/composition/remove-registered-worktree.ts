...
import type { GitWorktreeInfo } from '@yiru/runtime-protocol/workbench/worktree-types'
...
import {
  ...
  listWorktreesStrict,
  removeWorktree
} from '~main/git/worktree/worktree'
import { getEffectiveHooks } from '~main/hooks/config'
...
} from '~main/worktree/removal-recovery'
import {

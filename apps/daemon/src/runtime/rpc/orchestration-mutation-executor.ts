...
import { isOrchestrationMutation } from '~main/orchestration/rpc-contract'
...
export class OrchestrationMutationExecutor {
  ...
  constructor(runtime: YiruRuntimeService) {
      ...
      throw new OrchestrationError(
        ...
        recovery
          ? {
              ...
              recoveryCommand: `yiru orchestration worker-show --dispatch ${recovery.dispatchId} --json`
            }
          : { requestId }
      )
    }

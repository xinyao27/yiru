...
import { isBrowserUiRuntimeRpcParams } from '@yiru/runtime-protocol/workbench/runtime-rpc-feature-interaction-source'
...
export function getRuntimeFeatureInteractionId(
  ...
  if (method.startsWith('browser.') && isBrowserUiRuntimeRpcParams(rawParams)) {
    return null
  }

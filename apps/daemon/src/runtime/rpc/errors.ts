import { COMPUTER_ERROR_CODES } from '@yiru/runtime-protocol/workbench/runtime-types'
...
import { computerUseErrorRecoveryData } from './error-recovery'
...
// Why: the YiruRuntimeService throws plain Error objects whose `message` is

import type { OrchestrationMessageReadInput } from '@yiru/runtime-protocol/contract'
...
import { parseMessageTypes } from './message-read-request'
import { resolveRunScope } from './run-scope'

export async function handleOrchestrationCheck(
  params: OrchestrationMessageReadInput,

...
import type { GitProviderStatusOptions } from '~main/agents/provider-runtime/git-provider-status-options'
import { checkIgnoredPaths } from '~main/git/repo/check-ignored-paths'
import { listLocalBranches } from '~main/git/repo/checkout'
import { getRemoteCommitUrl, getRemoteFileUrl } from '~main/git/repo/repo'
import { getHistory as getGitHistory } from '~main/git/status/history'
import { findKnownHugeFolderPathsToIgnore } from '~main/git/status/huge-folder-ignore'
import {

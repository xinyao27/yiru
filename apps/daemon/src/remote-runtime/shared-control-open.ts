...
import { openRemoteRuntimeWebSocket, type RemoteRuntimeWebSocket } from './request-websocket'
import { formatSharedControlCloseMessage } from './shared-control-protocol'
import { pingRemoteRuntimeSocket, terminateRemoteRuntimeSocket } from './socket'
import {
  ...
  const monitor = startRemoteRuntimeSocketLiveness({
    ...
    onDead: () => {
      ...
      try {
        ...
        terminateRemoteRuntimeSocket(ws)
      } catch {

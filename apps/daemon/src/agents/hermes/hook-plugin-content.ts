export const HERMES_PLUGIN_NAME = 'yiru-status'
export const HERMES_PLUGIN_MARKER = 'Managed by Yiru. Do not edit; changes may be overwritten.'
...
export function getHermesPluginManifest(): string {
  return [
...
export function getHermesPluginInitSource(): string {

...
import { runCodexHookTrustGrantSessionSync } from './app-server-grant-bridge'
import {
  computeTrustKey,
  computeTrustedHash,
...
const DISABLE_ENV_FLAG = 'YIRU_DISABLE_CODEX_TRUST_RPC'
...
export type CodexManagedTrustGrantPlan = {
  ...
  /** Managed trust identities Yiru just wrote (no trustedHash). */
...
/**
 * Grants trust for Yiru's managed Codex hooks through codex's own app-server

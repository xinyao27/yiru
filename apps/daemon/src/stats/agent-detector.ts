...
export class AgentDetector {
   ...
   */
  onData(ptyId: string, rawData: string, at: number, scanFlags?: TerminalChunkScanFlags): void {
    ...
    const title = this.extractLastOscTitleForPty(ptyId, rawData, scanFlags)
    if (title === null) {
      return
    }

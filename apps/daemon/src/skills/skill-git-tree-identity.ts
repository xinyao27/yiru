 ...
 * match Git's canonical tree hash exactly — a near-miss never matches anything and silently
 * disables the verdict's lock check. This is the single implementation used for installed skill
 * identity and must be changed with care.
 *

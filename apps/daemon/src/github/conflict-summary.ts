import type { PRConflictSummary } from '@yiru/runtime-protocol/workbench/types'
import {
  isUnsupportedMergeTreeMergeBaseError,
  isUnsupportedMergeTreeWriteTreeError
} from '~main/git/repo/merge-tree-capability'

import { getLocalGitCapabilityCache } from '../git/runner/capability-state'

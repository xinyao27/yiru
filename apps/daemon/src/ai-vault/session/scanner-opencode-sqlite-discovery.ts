...
import type { AiVaultAgent, AiVaultScanIssue } from '@yiru/runtime-protocol/model/agent'
import { columnExists, tableExists } from '~main/agents/opencode/usage/schema-introspection'
...
import type { FileWithMtime, SessionFileCandidate, SessionFileDiscovery } from './scanner-types'
import { errorMessage } from './scanner-values'

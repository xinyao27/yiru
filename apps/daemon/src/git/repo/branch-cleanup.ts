import type { GitCapabilityCache } from '@yiru/runtime-protocol/workbench/git/capability-cache'

import { isUnsupportedMergeTreeWriteTreeError } from './merge-tree-capability'

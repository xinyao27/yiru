...
import { isForEachRefExcludeUnsupportedError } from '~main/git/runner/ref-command-capabilities'
...
export { isForEachRefExcludeUnsupportedError } from '~main/git/runner/ref-command-capabilities'

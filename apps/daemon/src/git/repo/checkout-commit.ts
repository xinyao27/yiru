import type { GitCheckoutCommitResult } from '@yiru/runtime-protocol/workbench/git/write-op-results'
import { isWorkingTreeDirty, resolveCommitOid } from '~main/git/status/write-preconditions'

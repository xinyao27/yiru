import type { GitDiffResult, GitStatusResult } from '@yiru/runtime-protocol/workbench/types'
import { clearGitStatusLineStatsCache } from '~main/git/status/status-line-stats-cache'
import { InFlightPromiseDedupe } from '~main/in-flight-promise-dedupe'

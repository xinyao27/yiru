...
import { getLargeDiffRenderLimit } from '@yiru/runtime-protocol/workbench/large-diff-render-limit'
import type { GitDiffResult } from '@yiru/runtime-protocol/workbench/types'
import { isBinaryBuffer } from '~main/binary-buffer'

import { isMaxBufferOverflowError } from '../runner/max-buffer-overflow'
import { gitExecFileAsyncBuffer } from '../runner/runner'

...
import type { GitRemoteIdentity } from '@yiru/runtime-protocol/workbench/git/remote-identity'
import { normalizeRepoBadgeColor } from '@yiru/runtime-protocol/workbench/repo-badge-color'
import type { RepoProjectHostSetupMethod, Repo } from '@yiru/runtime-protocol/workbench/types'

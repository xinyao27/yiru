...
import { getBaseRefDefault } from '~main/git/repo/repo'
import { hasLocalCommitObject, isFullGitObjectId } from '~main/git/status/commit-object-ref'
import { hasWorktreeBaseCommitRef } from '~main/git/worktree/worktree-base-ref-probe'
import { resolveWorktreeAddBaseRef } from '~main/workspace/worktree-base-ref'

import { resolveWorktreeCreateBase } from './create-base'

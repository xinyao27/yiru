import type { GitWorktreeInfo, RemoveWorktreeResult } from '@yiru/runtime-protocol/workbench/types'
import { assertWorktreeUnlockedForRemoval } from '@yiru/runtime-protocol/workbench/workspace/worktree-removal'

import { gitExecFileAsync } from '../git/runner/runner'
import { listWorktreesStrict, type GitWorktreeExecOptions } from '../git/worktree/worktree'
import { removeLocalWorktreePath } from './filesystem'
import { areWorktreePathsEqual, formatWorktreeRemovalError } from './logic'

...
} from './include-copy-budget'
import { findExistingWorktreeSymlinkPaths, getSafeRelativePath } from './symlink-detection'
...
// 'share': always symlink (yiru.yaml sharedDirectories). An APFS clone would give
...
/** Symlink `yiru.yaml` `worktree.sharedDirectories` into a freshly-created

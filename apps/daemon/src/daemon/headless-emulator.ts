...
} from '@yiru/runtime-protocol/workbench/terminal/serialize-absolute-cursor'
import { activateYiruTerminalUnicodeProvider } from '@yiru/runtime-protocol/workbench/terminal/unicode-provider'
import type { TerminalViewAttributes } from '@yiru/runtime-protocol/workbench/terminal/view-attributes'
import { advancePartialEscapeTail } from '~main/terminal-output/partial-escape-tail'
...
import type { TerminalModes, TerminalSnapshot } from './terminal-snapshot'
...
export class HeadlessEmulator {
  ...
  write(data: string, opts: HeadlessEmulatorWriteOptions = {}): Promise<void> {
    ...
    this.oscText.scan(data, opts.scanFlags)
    ...
    return new Promise<void>((resolve) => {
      this.terminal.write(data, () => {
        ...
        this.mouseModes.scan(data, opts.scanFlags)

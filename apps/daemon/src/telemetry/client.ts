...
const BUILD_IDENTITY: 'stable' | 'rc' | null =
  process.env.YIRU_BUILD_IDENTITY === 'stable' || process.env.YIRU_BUILD_IDENTITY === 'rc'
    ? process.env.YIRU_BUILD_IDENTITY
    : null
const WRITE_KEY: string | null = process.env.YIRU_POSTHOG_WRITE_KEY?.trim() || null
 ...
 * YIRU_TELEMETRY_DISABLED). The SDK flag does not persist across process

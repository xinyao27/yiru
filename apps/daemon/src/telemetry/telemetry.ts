...
import type { OptInVia } from '@yiru/runtime-protocol/workbench/telemetry-events'
...
export function initializeShellTelemetryService(store: Store): void {
  storeRef = store
}

export function trackShellTelemetry(name: unknown, props: unknown): void {
...
export function setShellTelemetryOptIn(optedIn: unknown): Promise<void> | void {
...
export function getShellTelemetryConsentState(): ConsentState {
  if (!storeRef) {
...
export function acknowledgeShellTelemetryBanner(): Promise<void> | void {

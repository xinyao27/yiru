...
// `runtime-protocol/workbench/telemetry-events` IS the validator. There is no parallel
...
// without reaching into the runtime-protocol implementation directly. Keeps the

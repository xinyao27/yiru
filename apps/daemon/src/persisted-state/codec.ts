import { getDefaultPersistedState } from '@yiru/runtime-protocol/workbench/constants'
import { normalizeFeatureInteractionTelemetryBuckets } from '@yiru/runtime-protocol/workbench/feature-interactions'
import { normalizeProjectGroups } from '@yiru/runtime-protocol/workbench/project-groups'
import type { PersistedState } from '@yiru/runtime-protocol/workbench/types'
import { normalizeFolderWorkspaces } from '~main/folder-workspaces'

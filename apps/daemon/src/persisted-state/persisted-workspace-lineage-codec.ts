import type { WorkspaceLineage, WorkspaceKey } from '@yiru/runtime-protocol/workbench/types'
import { isWorkspaceKey } from '@yiru/runtime-protocol/workbench/workspace/scope'

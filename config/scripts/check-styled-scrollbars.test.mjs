...
describe('check-styled-scrollbars', () => {
  it('reports renderer vertical scroll containers without a Yiru scrollbar style', () => {
  ...
  it('does not accept nonexistent scrollbar classes as Yiru scrollbar styles', () => {
    const reports = reportUnstyledScrollbars(
      'Example.tsx',
  ...
  it('reports inline vertical overflow without a Yiru scrollbar class', () => {
    const reports = reportUnstyledScrollbars(
      'Example.tsx',
  ...
  it('accepts inline vertical overflow with a stable Yiru scrollbar class', () => {
    const reports = reportUnstyledScrollbars(
      'Example.tsx',
  ...
  it('reports logical inline style spreads without a Yiru scrollbar class', () => {
    const reports = reportUnstyledScrollbars(
      'Example.tsx',

...
export const FEATURE_WALL_TILES: readonly FeatureWallTile[] = [
  ...
  },
  {
    ...
    docsUrl: 'https://yiru.ai/docs/browser/design-mode'
  },
  {
    id: 'tile-06',
    kind: 'media',
    ...
    docsUrl: 'https://yiru.ai/docs/ssh'
  },
  {
    id: 'tile-07',
    kind: 'media',
    ...
    owner: 'editor',
    docsUrl: 'https://yiru.ai/docs/editing/file-explorer'
  },
  {
    id: 'tile-08',
    kind: 'media',
  ...
  },
  {
    ...
    owner: 'yiru-cli',
    docsUrl: 'https://yiru.ai/docs/cli/overview'
  },
  {
    id: 'tile-10',
    kind: 'media',
    ...
    owner: 'keyboard-ux',
    docsUrl: 'https://yiru.ai/docs/model/quick-open'
  },
  {
    id: 'tile-11',
    kind: 'media',
    ...
    docsUrl: 'https://yiru.ai/docs/agents/usage-tracking'
  },
  {
    id: 'tile-12',
    kind: 'media',
    ...
    owner: 'file-preview',
    docsUrl: 'https://yiru.ai/docs/editing/viewers'
  }
] as const

...
export const ORCHESTRATION_COMMAND_SPECS: CommandSpec[] = [
  {
    ...
    usage:
      'yiru orchestration send --to <handle> --subject <text> [--from <handle>] [--body <text>] [--type <type>] [--priority <level>] [--thread-id <id>] [--payload <json>] [--task-id <id>] [--dispatch-id <id>] [--files-modified <csv>] [--report-path <path>] [--phase <text>] [--json]',
    allowedFlags: [
      ...GLOBAL_FLAGS,
      'to',
      'from',
  ...
  },
  {
    ...
    usage: 'yiru orchestration reply --id <msg_id> --body <text> [--from <handle>] [--json]',
  ...
  },
  {
    ...
    usage:
      'yiru orchestration task-create --spec <text> [--task-title <text>] [--display-name <text>] [--deps <json_array>] [--parent <task_id>] [--json]',
  ...
  },
  {
    ...
    usage: 'yiru orchestration task-list [--status <status>] [--ready] [--brief] [--json]',
  ...
  },
  {
    ...
    usage:
      'yiru orchestration dispatch --task <task_id> --to <handle> [--from <handle>] [--inject] [--dry-run] [--return-preamble] [--json]',
  ...
  },
  {
    ...
    usage: 'yiru orchestration run-stop [--json]',

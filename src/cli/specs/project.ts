...
export const PROJECT_COMMAND_SPECS: CommandSpec[] = [
  {
    path: ['project', 'list'],
    summary: 'List durable projects known to Yiru',
    usage: 'yiru project list [--json]',
    allowedFlags: [...GLOBAL_FLAGS],
    examples: ['yiru project list', 'yiru project list --json']
  },
  {
    path: ['project', 'setups'],
    summary: 'List project host setups',
    usage: 'yiru project setups [--project <id>] [--host <host-id>] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'project', 'host'],
    notes: ['A setup means a project is available on a host at a concrete filesystem path.'],
    examples: [
      'yiru project setups',
      'yiru project setups --project github:xinyao27/yiru',
  ...
  },
  {
    ...
    examples: [
      ...
      'yiru project setup-clone --project github:xinyao27/yiru --host runtime:gpu --url https://github.com/xinyao27/yiru.git --destination /srv --json'
    ]
  },
  {
    ...
    examples: [
      'yiru project setup-create --project github:xinyao27/yiru --host runtime:gpu --state setting-up --method provisioned --json'
    ]
  },
  {
    ...
    examples: [
      'yiru project setup-update --setup github:xinyao27/yiru::gpu --display-name "GPU VM"',
      'yiru project setup-update --setup github:xinyao27/yiru::gpu --path /srv/yiru --state ready --json'
    ]
  },
  {
    ...
    usage: 'yiru project setup-delete --setup <setup-id> [--json]',
    ...
    examples: ['yiru project setup-delete --setup github:xinyao27/yiru::gpu --json']
  }
]

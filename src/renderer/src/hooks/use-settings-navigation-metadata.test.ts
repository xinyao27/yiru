...
import { buildSettingsNavigationMetadata } from './use-settings-navigation-metadata'
...
describe('settings navigation metadata', () => {
  ...
  it('does not import Settings page or pane UI modules from the metadata hook', () => {
    ...
    const hookSource = readFileSync(resolve(testDir, 'use-settings-navigation-metadata.ts'), 'utf8')

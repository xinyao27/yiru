...
function CodeCell({
  ...
  return (
    <div className="bg-[var(--editor-surface)] focus-within:ring-1 focus-within:ring-ring">
      <Editor
        height={editorHeight}
...
export default function IpynbViewer({
  ...
  if (parsed.error || !parsed.notebook) {
    return (
      <div className="flex h-full items-center justify-center bg-[var(--editor-surface)] p-6 text-sm text-muted-foreground">
  ...
  return (
    <div
      ref={setRootRef}
      className="h-full min-h-0 overflow-auto bg-[var(--editor-surface)] scrollbar-editor"

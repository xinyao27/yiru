...
import { SourceControlAgentActionDialog } from '@/components/right-sidebar/source-control-agent-action-dialog'
import {
    ...
    <div className="flex h-full min-h-0 flex-col">
      ...
      <div className="flex-none border-b border-border/60 px-6 py-5">
        <div className="flex items-start gap-4">
          ...
          <div className="flex shrink-0 items-center gap-2">
            {/* Why: Yiru's signature affordance — keep this primary so it stands out

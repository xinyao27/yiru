...
const managerRoster: YiruOrgMembersRoster = {
  members: [
...
const memberRoster: YiruOrgMembersRoster = {
  members: [
...
function stubOrgMembersApi(roster: YiruOrgMembersRoster): void {
...
describe('YiruProfileOrgMembersDialog', () => {
  afterEach(() => {
    cleanup()
    vi.restoreAllMocks()
  })
  ...
  it('shows the invite form and a role select per member for managers', async () => {
    ...
    expect(screen.getByText("They haven't signed in to Yiru yet.")).toBeTruthy()
  })

...
vi.mock('./workspace-kanban-drawer-header', () => ({
  default: () => <div data-testid="workspace-board-header" />
}))

vi.mock('./workspace-kanban-lane-grid', () => ({
  default: () => <div data-testid="workspace-board-lanes" />
}))

vi.mock('./workspace-kanban-area-selection-overlay', () => ({
  default: React.forwardRef<HTMLDivElement>((_, ref) => <div ref={ref} />)
}))

vi.mock('./workspace-kanban-pin-drop-target', () => ({

...
import WorkspaceKanbanAreaSelectionOverlay from './workspace-kanban-area-selection-overlay'
import WorkspaceKanbanDrawerHeader from './workspace-kanban-drawer-header'
import WorkspaceKanbanLaneGrid from './workspace-kanban-lane-grid'
import WorkspaceKanbanPinDropTarget from './workspace-kanban-pin-drop-target'
import {
  getWorkspaceStatus,
  ...
  return (
    <Sheet open={open} onOpenChange={handleSheetOpenChange} modal={false}>
      <SheetContent
        ...
        className="worktree-sidebar-theme workspace-kanban-sheet-content bg-sidebar p-0 sm:max-w-none"
        overlayStyle={{

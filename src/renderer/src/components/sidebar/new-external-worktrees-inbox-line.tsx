...
export default function NewExternalWorktreesInboxLine({
  ...
  return (
    ...
    >
      ...
      {isExpanded ? (
        <div className="ml-4 mt-0.5 border-l border-sidebar-border pb-1 pl-2">
          ...
          <ul className="grid gap-0.5">
            {inboxWorktrees.map((worktree) => (
              <li
                ...
                className="flex min-h-7 min-w-0 items-center gap-2 rounded-md px-1.5 py-1 text-xs hover:bg-sidebar-accent"
              >

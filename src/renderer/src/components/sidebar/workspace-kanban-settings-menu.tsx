...
import { SettingsSwitch } from '../settings/settings-form-controls'
import type { WorkspaceStatusDefinition } from '../../../../shared/types'
import { getWorkspaceStatusVisualMeta } from './workspace-status'
import WorkspaceStatusAppearancePopover from './workspace-status-appearance-popover'
    ...
    >
      ...
      >
        <div className="px-1 pb-2">
          <div className="flex items-start justify-between gap-3 rounded-md px-1.5 py-1.5 hover:bg-sidebar-accent/70">

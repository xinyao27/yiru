  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="group relative flex h-7 w-full items-center rounded-md border border-sidebar-border/70 bg-sidebar-foreground/5 pl-7 pr-1.5 text-left text-[12px] font-medium tracking-tight text-sidebar-foreground/45 transition-colors hover:border-sidebar-border hover:bg-sidebar-foreground/8 hover:text-sidebar-foreground/60 focus-visible:outline-none focus-visible:ring-[3px] focus-visible:ring-sidebar-ring/50"
      >
        <Search
          className="pointer-events-none absolute left-2 top-1/2 size-3 -translate-y-1/2 text-sidebar-foreground/30"
          strokeWidth={1.75}
        />

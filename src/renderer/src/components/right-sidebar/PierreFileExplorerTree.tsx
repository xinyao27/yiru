...
import { usePierreFileTreeNativeDrop } from './usePierreFileTreeNativeDrop'
import { usePierreFileTreeFlash } from './usePierreFileTreeFlash'
import { usePierreFileTreeDragPayload } from './usePierreFileTreeDragPayload'
...
>(function PierreFileExplorerTree(
  ...
  return (
    <FileTree
      model={model}
      className="yiru-pierre-file-tree block h-full min-h-0 w-full bg-sidebar"

...
import { buildCommitMessageGenerationParams } from './source-control-text-generation-dialog'
import {
  getDefaultSourceControlTextGenerationSaveTargetKey,
  SourceControlTextGenerationDialogForm
} from './source-control-text-generation-dialog-form'
import {
  applyCommitMessageGenerationDefaults,
  applySourceControlTextGenerationDefaults
} from './source-control-text-generation-default-application'

vi.mock('../source-control/source-control-action-variable-chips', () => ({

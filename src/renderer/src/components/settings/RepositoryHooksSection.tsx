...
import { Warning as AlertTriangle, CaretRight as ChevronRight, Plus } from '@phosphor-icons/react'
    ...
    default:
      return {
        ...
        description: translate(
          ...
          'Add an `yiru.yaml` file to enable shared setup, archive, or issue-automation defaults for this repo. Example template:'
        )
      }
  }
}
                    ...
                    <div className="space-y-2 text-xs text-muted-foreground">
                      <p>
                        {translate(
                          ...
                          'The file is present, but Yiru could not find valid `scripts` or `issueCommand` definitions.'
                        )}
                      </p>

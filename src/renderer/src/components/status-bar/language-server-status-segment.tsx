            ...
            <PopoverTrigger
              render={
                <button
                  ...
                  className="inline-flex cursor-pointer items-center gap-1.5 px-1 py-0.5 hover:bg-accent/70"
                ...
                >
                  {state === 'starting' ? (
                    ...
                    <WarningCircle className="size-3 text-destructive" />
                  ) : (
      ...
      >
        ...
        <div className="space-y-3 px-3 py-3">
          ...
          {logsLoading ? (
            ...
            <pre className="scrollbar-sleek max-h-48 overflow-auto border border-border bg-muted p-2 font-mono text-[11px] leading-relaxed text-muted-foreground whitespace-pre-wrap">
              {logs.join('\n')}
            </pre>
          ) : current ? (
  ...
  return (
    <div className="space-y-1 text-xs">
      <div className="flex items-center justify-between gap-3">
        <span className="truncate font-mono text-foreground">{workspace}</span>

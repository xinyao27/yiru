...
import {
  ...
  Gear as Settings,
  ArrowCounterClockwise as UndoDot,
  UserMinus,
  UserPlus,
  Wrench,
  X
...
import { DiffSectionItem } from '@/components/editor/diff-section-item'
import type { DecoratedDiffComment } from '@/components/diff-comments/use-diff-comment-decorator'
import {
  CombinedDiffFileTree,
  createCombinedDiffSectionIndexMap,
  handleCombinedDiffFileTreeNavigation
} from '@/components/editor/combined-diff-file-tree'
import {
...
import { useRepoLabels, useRepoAssignees, useImmediateMutation } from '@/hooks/use-issue-metadata'
import { useRepoLabelsBySlug, useRepoAssigneesBySlug } from '@/hooks/use-github-slug-metadata'
...
const MonacoCodeExcerpt = lazy(() => import('@/components/editor/monaco-code-excerpt'))
            ...
            >
              <span className="inline-flex items-center gap-1.5">
                {localState === 'closed' ? (
                  ...
                  <CircleDot
                    className={cn(isSidebar ? 'size-3.5' : 'size-3', 'text-emerald-500')}
                  />
                )}

...
describe('shellEscapePath', () => {
  ...
  it('keeps safe Windows paths unquoted', () => {
    expect(shellEscapePath('C:\\Users\\yiru\\file.txt', 'windows')).toBe(
      'C:\\Users\\yiru\\file.txt'
    )
  })

  it('double-quotes Windows paths with spaces', () => {
    expect(shellEscapePath('C:\\Users\\yiru\\my file.txt', 'windows')).toBe(
      '"C:\\Users\\yiru\\my file.txt"'
    )
  })

  it('double-quotes Windows paths with cmd separators', () => {
    expect(shellEscapePath('C:\\Users\\yiru\\a&b.txt', 'windows')).toBe(
      '"C:\\Users\\yiru\\a&b.txt"'
    )
  })
  ...
  it('uses POSIX escaping for SSH drops regardless of client OS', () => {
    ...
    expect(shellEscapePath("/home/u/wt/.yiru/drops/my file's $draft.txt", 'posix')).toBe(
      "'/home/u/wt/.yiru/drops/my file'\\''s $draft.txt'"
    )
  })
})

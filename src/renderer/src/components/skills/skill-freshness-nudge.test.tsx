...
import { SkillFreshnessNudge } from './skill-freshness-nudge'
...
function placement(
  ...
  return {
    ...
    unresolvedPath: '/home/.agents/skills/yiru-cli',
    resolvedPath: '/home/.agents/skills/yiru-cli',
    physicalIdentity: 'physical-yiru-cli',
...
vi.mock('./skill-freshness-update-dialog-request', () => ({
...
const DISMISSAL_KEY = ['physical-yiru-cli', 'yiru-cli', '2'].join('\0')

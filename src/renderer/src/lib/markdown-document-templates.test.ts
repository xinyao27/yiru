...
describe('markdown document templates', () => {
  ...
  it('discovers markdown files under .yiru/templates and skips unsafe entries', async () => {
    const readDir = stubReadDir({
      ...
      '/repo/.yiru/templates/nested': [entry('meeting.markdown'), entry('brief.mdx')]
    })
    ...
    await expect(
      ...
      {
        id: '.yiru/templates/nested/brief.mdx',
        name: 'Brief',
        filePath: '/repo/.yiru/templates/nested/brief.mdx',
        relativePath: '.yiru/templates/nested/brief.mdx',
        templateRelativePath: 'nested/brief.mdx',
        basename: 'brief.mdx'
      },
      {
        id: '.yiru/templates/daily-note.md',
        name: 'Daily note',
        filePath: '/repo/.yiru/templates/daily-note.md',
        relativePath: '.yiru/templates/daily-note.md',
        templateRelativePath: 'daily-note.md',
        basename: 'daily-note.md'
      },
      {
        id: '.yiru/templates/nested/meeting.markdown',
        name: 'Meeting',
        filePath: '/repo/.yiru/templates/nested/meeting.markdown',
        relativePath: '.yiru/templates/nested/meeting.markdown',
  ...
  it('keeps Windows file paths native while exposing root-relative template paths', async () => {
    stubReadDir({
      'C:\\repo\\.yiru\\templates': [entry('daily.md')]
    })
    ...
    await expect(
      ...
      {
        id: '.yiru/templates/daily.md',
        name: 'Daily',
        filePath: 'C:\\repo\\.yiru\\templates\\daily.md',
        relativePath: '.yiru/templates/daily.md',

...
// Why: prefill-without-submit needs an env-var the bundled `yiru-prefill.ts`
 ...
 *  `YIRU_OMP_PREFILL_ENV_VAR` instead. */
export const YIRU_PI_PREFILL_ENV_VAR = PREFILL_ENV_VAR_BY_KIND.pi

/** OMP's prefill env var. Mirrors `YIRU_PI_PREFILL_ENV_VAR` for OMP launches
 *  so renderer plans and shell-ready restore lines can stay agent-scoped. */
export const YIRU_OMP_PREFILL_ENV_VAR = PREFILL_ENV_VAR_BY_KIND.omp

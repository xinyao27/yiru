...
export function findYiruProfileProjectsByPath(
  ...
  const projects: FindYiruProfileProjectsByPathResult['projects'] = []

  for (const profile of getYiruProfileListState(userDataPath).profiles) {

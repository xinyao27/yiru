...
describe('DroidHookService', () => {
  ...
  beforeEach(() => {
    homeDir = mkdtempSync(join(tmpdir(), 'yiru-droid-home-'))
    userDataDir = mkdtempSync(join(tmpdir(), 'yiru-droid-user-data-'))
  ...
  it.skipIf(process.platform !== 'win32')(
    ...
    () => {
      const spaceHome = join(tmpdir(), 'yiru droid home with spaces')

...
describe('decodeGrokTranscriptLine', () => {
  ...
  it.each([
    'C:\\Users\\me\\AppData\\Local\\Temp\\yiru-paste-1783675302563-2207c073-535f-4b83-a181-61127c8bbd68.png',
    '/tmp/yiru-paste-1783675302563-2207c073-535f-4b83-a181-61127c8bbd68.png',
    'C:\\yiru-paste-1783675302563-2207c073-535f-4b83-a181-61127c8bbd68.png',
    '/yiru-paste-1783675302563-2207c073-535f-4b83-a181-61127c8bbd68.png',
    '\\\\server\\temp\\yiru-paste-1783675302563-2207c073-535f-4b83-a181-61127c8bbd68.png'
  ...
  it('restores an attachment-only pasted image from Grok transcript text', () => {
    const imagePath = '/tmp/yiru-paste-1783675302563-2207c073-535f-4b83-a181-61127c8bbd68.png'
    const line = JSON.stringify({
      type: 'user',
  ...
  it('preserves ordinary prompts that mention pasted-image filenames', () => {
    const text = 'Explain what a yiru-paste-123-example.png file is'
    const line = JSON.stringify({
      type: 'user',

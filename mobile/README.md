...
When a verdict is `blocked`, `mobile/src/components/protocol-block-screen.tsx` points mobile updates to TestFlight or the rolling Android APK and desktop updates to GitHub Releases.

...
vi.mock('./pr-section', () => ({ PRSection: 'PRSection' }))
vi.mock('./comment-markdown', () => ({ CommentMarkdown: 'CommentMarkdown' }))
vi.mock('./pr-comment-card', () => ({ PRCommentCard: 'PRCommentCard' }))
vi.mock('./pr-comment-composer', () => ({ PRCommentComposer: 'PRCommentComposer' }))

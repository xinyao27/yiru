...
<h3 align="center"><a href="https://yiru.ai/download"><ins>下载 Yiru</ins></a></h3>
...
[移动端文档 →](https://yiru.ai/docs/mobile)
...
[文档 →](https://yiru.ai/docs/model/worktrees)
...
[文档 →](https://yiru.ai/docs/terminal)
...
[文档 →](https://yiru.ai/docs/browser/design-mode)
...
[文档 →](https://yiru.ai/docs/review/linear)
...
[文档 →](https://yiru.ai/docs/review/annotate-ai-diff)
...
[文档 →](https://yiru.ai/docs/editing/file-explorer)
...
[文档 →](https://yiru.ai/docs/cli/overview)
...
- **[快速打开](https://yiru.ai/docs/model/quick-open)** — 在 worktree、文件、智能体、命令和仓库上下文之间搜索，不打断你的心流。
- **[账号切换与用量追踪](https://yiru.ai/docs/agents/usage-tracking)** — 查看 Claude 和 Codex 的用量与限额重置时间，并且无需重新登录即可热切换账号。
- **[丰富仓库预览](https://yiru.ai/docs/editing/markdown)** — 在工作区中预览 Markdown、图片、PDF 和仓库文档。
- **[Computer Use](https://yiru.ai/docs/cli/computer-use)** — 当工作流需要真实交互时，让智能体操作桌面应用和可见 UI。
- **[通知与未读状态](https://yiru.ai/docs/notifications)** — 第一时间知道智能体何时完成或需要关注，并可将会话标记为未读，稍后再回来处理。
...
- **[从 yiru.ai 下载](https://yiru.ai/download)**
- 或直接获取安装包：[macOS Apple Silicon](https://github.com/xinyao27/yiru/releases/latest/download/yiru-macos-arm64.dmg) · [macOS Intel](https://github.com/xinyao27/yiru/releases/latest/download/yiru-macos-x64.dmg) · [Windows（.exe，可用时）](https://github.com/xinyao27/yiru/releases) · [Linux AppImage](https://github.com/xinyao27/yiru/releases/latest/download/yiru-linux.AppImage) · [全部构建](https://github.com/xinyao27/yiru/releases/latest)
- 只有配置了 SignPath 签名时才会发布 Windows 构建；macOS 和 Linux 版本可以独立发布。

### 移动 Companion 应用 — iOS、Android

与桌面应用配对，用手机监控并指挥你的智能体。

新的移动端安装包可用后会在 [GitHub Releases](https://github.com/xinyao27/yiru/releases) 中公布。
...
- **隐私:** 查看[隐私与遥测文档](https://yiru.ai/docs/telemetry)，了解 Yiru 收集哪些匿名使用数据以及如何退出。

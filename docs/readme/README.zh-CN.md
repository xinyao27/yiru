...
<p align="center">
  <a href="https://github.com/paperboytm/yiru/stargazers"><img src="https://badgen.net/github/stars/paperboytm/yiru?label=%E2%98%85" alt="GitHub Star 数" /></a>
  <a href="https://github.com/paperboytm/yiru/releases"><img src="../assets/readme-downloads.svg" alt="所有版本的总下载量" /></a>
  <img src="https://badgen.net/github/license/paperboytm/yiru" alt="许可证" />
  <a href="https://discord.gg/fzjDKHxv8Q"><img src="https://img.shields.io/badge/Discord-5865F2?logo=discord&logoColor=white" alt="加入 Yiru Discord" /></a>
  <a href="https://x.com/yiru_build"><img src="https://img.shields.io/badge/X-000000?logo=x&logoColor=white" alt="在 X 上关注 Yiru" /></a>
...
<h3 align="center"><a href="https://onyiru.dev/download"><ins>下载 Yiru</ins></a></h3>
...
[iOS App Store](https://apps.apple.com/us/app/yiru/id6766130217) · [Android APK](https://github.com/paperboytm/yiru/releases/download/mobile-android-v0.0.31/app-release.apk) · [文档 →](https://www.onyiru.dev/docs/mobile)
...
[文档 →](https://www.onyiru.dev/docs/model/worktrees)
...
[文档 →](https://www.onyiru.dev/docs/terminal)
...
[文档 →](https://www.onyiru.dev/docs/browser/design-mode)
...
[文档 →](https://www.onyiru.dev/docs/review/linear)
...
[文档 →](https://www.onyiru.dev/docs/ssh)
...
在任意 diff 行上添加评论并发回给智能体 — 评审、编辑、提交，全程无需离开 Yiru。

[文档 →](https://www.onyiru.dev/docs/review/annotate-ai-diff)
...
[文档 →](https://www.onyiru.dev/docs/editing/file-explorer)
...
智能体也能驱动 Yiru — 用 `yiru worktree create`、`snapshot`、`click` 和 `fill` 把每个工作流脚本化。

[文档 →](https://www.onyiru.dev/docs/cli/overview)
...
- **[快速打开](https://www.onyiru.dev/docs/model/quick-open)** — 在 worktree、文件、智能体、命令和仓库上下文之间搜索，不打断你的心流。
- **[账号切换与用量追踪](https://www.onyiru.dev/docs/agents/usage-tracking)** — 查看 Claude 和 Codex 的用量与限额重置时间，并且无需重新登录即可热切换账号。
- **[丰富仓库预览](https://www.onyiru.dev/docs/editing/markdown)** — 在工作区中预览 Markdown、图片、PDF 和仓库文档。
- **[Computer Use](https://www.onyiru.dev/docs/cli/computer-use)** — 当工作流需要真实交互时，让智能体操作桌面应用和可见 UI。
- **[通知与未读状态](https://www.onyiru.dev/docs/notifications)** — 第一时间知道智能体何时完成或需要关注，并可将会话标记为未读，稍后再回来处理。
- **还有很多很多** — 我们每天发布新功能，这个列表永远跟不上。[更新日志](https://github.com/paperboytm/yiru/releases)才是真正的功能列表。

---

## 支持的智能体

适配**任何 CLI 智能体** — 只要能在终端里运行，就能在 Yiru 里运行。
...
- **[从 onYiru.dev 下载](https://onyiru.dev/download)**
- 或直接获取安装包：[macOS Apple Silicon](https://github.com/paperboytm/yiru/releases/latest/download/yiru-macos-arm64.dmg) · [macOS Intel](https://github.com/paperboytm/yiru/releases/latest/download/yiru-macos-x64.dmg) · [Windows (.exe)](https://github.com/paperboytm/yiru/releases/latest/download/yiru-windows-setup.exe) · [Linux AppImage](https://github.com/paperboytm/yiru/releases/latest/download/yiru-linux.AppImage) · [全部构建](https://github.com/paperboytm/yiru/releases/latest)
...
- **iOS:** [从 App Store 下载](https://apps.apple.com/us/app/yiru/id6766130217)
- **Android:** [下载 APK](https://github.com/paperboytm/yiru/releases/download/mobile-android-v0.0.31/app-release.apk)
...
- **Twitter / X:** 关注 **[@yiru_build](https://x.com/yiru_build)** 获取更新和公告。
- **微信:** 扫描二维码加入社区。如果第一个群已满，请使用备用微信群。

  <img src="../assets/wechat-qr.png" alt="Yiru 社区微信群二维码" width="160" />
  <img src="../assets/wechat-qr-backup.jpg" alt="Yiru 社区备用微信群二维码" width="160" />

- **反馈与想法:** 我们发布很快。缺少什么功能？[提交功能请求](https://github.com/paperboytm/yiru/issues)。
- **隐私:** 查看[隐私与遥测文档](https://www.onyiru.dev/docs/telemetry)，了解 Yiru 收集哪些匿名使用数据以及如何退出。
- **支持我们:** 给这个仓库点 [Star](https://github.com/paperboytm/yiru)，关注我们的日常发布。
...
<a href="https://github.com/paperboytm/yiru/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=paperboytm/yiru" alt="Yiru 贡献者" />
</a>

## 许可证

Yiru 是自由且开源的软件，遵循 [MIT 许可证](../../LICENSE)。

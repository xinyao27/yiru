...
<p align="center">
  <a href="https://github.com/stablyai/yiru/stargazers"><img src="https://badgen.net/github/stars/stablyai/yiru?label=%E2%98%85" alt="GitHub Star 数" /></a>
  <a href="https://github.com/stablyai/yiru/releases"><img src="../assets/readme-downloads.svg" alt="所有版本的总下载量" /></a>
  <img src="https://badgen.net/github/license/stablyai/yiru" alt="许可证" />
...
[iOS App Store](https://apps.apple.com/us/app/yiru/id6766130217) · [Android APK](https://github.com/stablyai/yiru/releases/download/mobile-android-v0.0.31/app-release.apk) · [文档 →](https://www.onyiru.dev/docs/mobile)
...
- **还有很多很多** — 我们每天发布新功能，这个列表永远跟不上。[更新日志](https://github.com/stablyai/yiru/releases)才是真正的功能列表。
...
- 或直接获取安装包：[macOS Apple Silicon](https://github.com/stablyai/yiru/releases/latest/download/yiru-macos-arm64.dmg) · [macOS Intel](https://github.com/stablyai/yiru/releases/latest/download/yiru-macos-x64.dmg) · [Windows (.exe)](https://github.com/stablyai/yiru/releases/latest/download/yiru-windows-setup.exe) · [Linux AppImage](https://github.com/stablyai/yiru/releases/latest/download/yiru-linux.AppImage) · [全部构建](https://github.com/stablyai/yiru/releases/latest)
...
- **Android:** [下载 APK](https://github.com/stablyai/yiru/releases/download/mobile-android-v0.0.31/app-release.apk)
...
- **反馈与想法:** 我们发布很快。缺少什么功能？[提交功能请求](https://github.com/stablyai/yiru/issues)。
- **隐私:** 查看[隐私与遥测文档](https://www.onyiru.dev/docs/telemetry)，了解 Yiru 收集哪些匿名使用数据以及如何退出。
- **支持我们:** 给这个仓库点 [Star](https://github.com/stablyai/yiru)，关注我们的日常发布。
...
<a href="https://github.com/stablyai/yiru/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=stablyai/yiru" alt="Yiru 贡献者" />
</a>

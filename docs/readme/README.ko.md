...
[iOS App Store](https://apps.apple.com/us/app/yiru/id6766130217) · [Android APK](https://github.com/xinyao27/yiru/releases/download/mobile-android-v0.0.31/app-release.apk) · [문서 →](https://www.onyiru.dev/docs/mobile)
...
- 또는 빌드를 직접 받기: [macOS Apple Silicon](https://github.com/xinyao27/yiru/releases/latest/download/yiru-macos-arm64.dmg) · [macOS Intel](https://github.com/xinyao27/yiru/releases/latest/download/yiru-macos-x64.dmg) · [Windows (.exe)](https://github.com/xinyao27/yiru/releases/latest/download/yiru-windows-setup.exe) · [Linux AppImage](https://github.com/xinyao27/yiru/releases/latest/download/yiru-linux.AppImage) · [전체 빌드](https://github.com/xinyao27/yiru/releases/latest)
...
- **Android:** [APK 다운로드](https://github.com/xinyao27/yiru/releases/download/mobile-android-v0.0.31/app-release.apk)

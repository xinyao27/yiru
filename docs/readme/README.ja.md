...
<h3 align="center"><a href="https://yiru.ai/download"><ins>Yiru をダウンロード</ins></a></h3>
...
[モバイル版ドキュメント →](https://yiru.ai/docs/mobile)
...
[ドキュメント →](https://yiru.ai/docs/model/worktrees)
...
[ドキュメント →](https://yiru.ai/docs/terminal)
...
[ドキュメント →](https://yiru.ai/docs/browser/design-mode)
...
[ドキュメント →](https://yiru.ai/docs/review/linear)
...
[ドキュメント →](https://yiru.ai/docs/review/annotate-ai-diff)
...
[ドキュメント →](https://yiru.ai/docs/editing/file-explorer)
...
[ドキュメント →](https://yiru.ai/docs/cli/overview)
...
- **[クイックオープン](https://yiru.ai/docs/model/quick-open)** — フローを離れずに、ワークツリー、ファイル、エージェント、コマンド、リポジトリコンテキストを横断検索できます。
- **[アカウント切り替えと使用量トラッキング](https://yiru.ai/docs/agents/usage-tracking)** — Claude と Codex の使用量やレート制限のリセットを確認し、再ログインなしでアカウントを切り替えられます。
- **[リッチなリポジトリプレビュー](https://yiru.ai/docs/editing/markdown)** — Markdown、画像、PDF、リポジトリ文書をワークスペース内でプレビューできます。
- **[Computer Use](https://yiru.ai/docs/cli/computer-use)** — 実際の操作が必要なワークフローでは、エージェントにデスクトップアプリや画面上の UI を操作させられます。
- **[通知と未読ステータス](https://yiru.ai/docs/notifications)** — エージェントの完了や要対応をすぐに把握し、スレッドを未読に戻して後で確認できます。
...
- **[yiru.ai からダウンロード](https://yiru.ai/download)**
- またはビルドを直接入手: [macOS Apple Silicon](https://github.com/xinyao27/yiru/releases/latest/download/yiru-macos-arm64.dmg) · [macOS Intel](https://github.com/xinyao27/yiru/releases/latest/download/yiru-macos-x64.dmg) · [Windows（.exe、利用可能な場合）](https://github.com/xinyao27/yiru/releases) · [Linux AppImage](https://github.com/xinyao27/yiru/releases/latest/download/yiru-linux.AppImage) · [すべてのビルド](https://github.com/xinyao27/yiru/releases/latest)
- Windows ビルドは SignPath 署名が設定されている場合のみ公開されます。macOS と Linux のリリースは独立して公開できます。

### モバイル Companion — iOS, Android

デスクトップアプリとペアリングして、スマートフォンからエージェントを監視・操作できます。

新しいモバイルビルドは、利用可能になり次第 [GitHub Releases](https://github.com/xinyao27/yiru/releases) で案内します。
...
- **プライバシー:** Yiru が収集する匿名の利用データとオプトアウトの方法については、[プライバシーとテレメトリーのドキュメント](https://yiru.ai/docs/telemetry)をご覧ください。
